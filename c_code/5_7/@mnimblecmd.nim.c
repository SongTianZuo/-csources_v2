...
{nimErr_ = nimErrorFlag();
	...
	nimln_(80);
	{
		...
		T5_ = substr__system_u7920(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_10));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA1_: ;
	...
	nimln_(90);
	{
		...
		T16_ = substr__system_u7908(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_16), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_17));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA14_: ;
	{
		...
		nimln_(96);
		{
			...
			T22_ = substr__system_u7908(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_19), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_20));
			nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
				...
				res = ((NI)0);
				{
					...
					while (1) {
						...
						nimln_(93);
						{
							NIM_BOOL T14_;
							T14_ = (NIM_BOOL)0;
							T14_ = eqeq___system_u7874(fX60gensym0_.gl_pathv[iX60gensym0_], ((NCSTRING) NIM_NIL));
							if (!!(!(T14_))) goto LA15_;

...
{	result = (NU32)0;
	nimlf_(303, "D:\\nim\\lib\\pure\\hashes.nim");
	nimln_(304);
	if (nimSubInt(((NI)32), r_p1, &TM__7tkD9cFJSchVDwHuwaY9bP9bA_7)) { raiseOverflow(); goto BeforeRet_;
	};
	result = (NU32)((NU32)((NU64)(x_p0) << (NU64)(r_p1)) | (NU32)((NU32)(x_p0) >> (NU64)((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_7))));
	}
BeforeRet_: ;
	popFrame();
	return result;
...
{nimErr_ = nimErrorFlag();
		...
		while (1) {
			...
			j = stepSize;
			{
				...
				while (1) {
					...
					if (!(((NI)0) < j)) goto LA4;
					nimln_(328);
					if (nimSubInt(j, ((NI)1), &TM__7tkD9cFJSchVDwHuwaY9bP9bA_4)) { raiseOverflow(); goto BeforeRet_;
					};
					j = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_4);
					nimln_(329);
					if (nimAddInt(i, j, &TM__7tkD9cFJSchVDwHuwaY9bP9bA_5)) { raiseOverflow(); goto BeforeRet_;
					};
					if ((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_5) < 0 || (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_5) >= x_p0Len_0){ raiseIndexError2((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_5),x_p0Len_0-1); goto BeforeRet_;
					}
					k1 = (NU32)((NU32)((NU64)(k1) << (NU64)(((NI)8))) | ((NU32) (x_p0[(NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_5)])));
				} LA4: ;
			}
			nimln_(332);
			if (nimAddInt(i, stepSize, &TM__7tkD9cFJSchVDwHuwaY9bP9bA_6)) { raiseOverflow(); goto BeforeRet_;
			};
			i = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_6);
			nimln_(334);
	...
	if (nimModInt(size, stepSize, &TM__7tkD9cFJSchVDwHuwaY9bP9bA_8)) { raiseOverflow(); goto BeforeRet_;
	};
	rem = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_8);
	{
		nimln_(345);
		while (1) {
			...
			nimln_(346);
			if (nimSubInt(rem, ((NI)1), &TM__7tkD9cFJSchVDwHuwaY9bP9bA_9)) { raiseOverflow(); goto BeforeRet_;
			};
			rem = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_9);
			nimln_(347);
			if (nimAddInt(i, rem, &TM__7tkD9cFJSchVDwHuwaY9bP9bA_10)) { raiseOverflow(); goto BeforeRet_;
			};
			if ((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_10) < 0 || (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_10) >= x_p0Len_0){ raiseIndexError2((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_10),x_p0Len_0-1); goto BeforeRet_;
			}
			k1_2 = (NU32)((NU32)((NU64)(k1_2) << (NU64)(((NI)8))) | ((NU32) (x_p0[(NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_10)])));
		} LA6: ;
	}
	nimln_(348);
...
{nimErr_ = nimErrorFlag();
	...
	h = ((NI)0);
	{
		...
		nimlf_(477, "D:\\nim\\lib\\pure\\hashes.nim");
		if (nimSubInt(x_p0.len, ((NI)1), &TM__7tkD9cFJSchVDwHuwaY9bP9bA_11)) { raiseOverflow(); goto BeforeRet_;
		};
		colontmp_ = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_11);
		nimlf_(90, "D:\\nim\\lib\\system\\iterators_1.nim");
		res = ((NI)0);
		{
			nimln_(91);
			while (1) {
				...
				nimln_(477);
				{
					...
					nimln_(480);
					if (nimAddInt(((NU8)(c)), ((NI)32), &TM__7tkD9cFJSchVDwHuwaY9bP9bA_12)) { raiseOverflow(); goto BeforeRet_;
					};
					if (((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_12)) < ((NI)0) || ((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_12)) > ((NI)255)){ raiseRangeErrorI((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_12), ((NI)0), ((NI)255)); goto BeforeRet_;
					}
					c = ((NIM_CHAR) (((NI) ((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_12)))));
				}
LA6_: ;
				nimln_(481);
				...
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimlf_(93, "D:\\nim\\lib\\system\\iterators_1.nim");
				if (nimAddInt(res, ((NI)1), &TM__7tkD9cFJSchVDwHuwaY9bP9bA_13)) { raiseOverflow(); goto BeforeRet_;
				};
				res = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_13);
			} LA3: ;
		}
	}
	nimlf_(482, "D:\\nim\\lib\\pure\\hashes.nim");
...
LA5_: ;
			{
				...
				nimln_(434);
				{
					...
					nimln_(435);
					if (nimAddInt(((NU8)(c)), ((NI)32), &TM__7tkD9cFJSchVDwHuwaY9bP9bA_15)) { raiseOverflow(); goto BeforeRet_;
					};
					if (((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_15)) < ((NI)0) || ((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_15)) > ((NI)255)){ raiseRangeErrorI((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_15), ((NI)0), ((NI)255)); goto BeforeRet_;
					}
					c = ((NIM_CHAR) (((NI) ((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_15)))));
				}
LA10_: ;
				nimln_(436);
				h = emarkamp___pureZhashes_u4(h, ((NU8)(c)));
				if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				nimln_(437);
				if (nimAddInt(i, ((NI)1), &TM__7tkD9cFJSchVDwHuwaY9bP9bA_16)) { raiseOverflow(); goto BeforeRet_;
				};
				i = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_16);
			}
LA3_: ;
		} LA2: ;
	}
...
N_LIB_PRIVATE N_NIMCALL(NI, hash__pureZhashes_u303)(NimStringV2 sBuf_p0, NI sPos_p1, NI ePos_p2) {
	NI result;
NIM_BOOL* nimErr_;
	nimfr_("hash", "D:\\nim\\lib\\pure\\hashes.nim");
{nimErr_ = nimErrorFlag();
...
N_LIB_PRIVATE N_NIMCALL(NI, hash__vm_u14065)(NU8* aBuf_p0, NI aBuf_p0Len_0, NI sPos_p1, NI ePos_p2) {
	NI result;
NIM_BOOL* nimErr_;
	nimfr_("hash", "D:\\nim\\lib\\pure\\hashes.nim");
{nimErr_ = nimErrorFlag();
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(541);
	T1_ = (NI)0;
	T1_ = hash__pureZhashes_u297((*x_p0).Field0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = emarkamp___pureZhashes_u4(result, T1_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = (NI)0;
	T2_ = hash__pureZhashes_u297((*x_p0).Field1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = emarkamp___pureZhashes_u4(result, T2_);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimln_(542);

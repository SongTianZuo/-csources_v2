...
{	{
		...
		if (((NI)(TM__A04lj5tT6ly3Jo7R9ckk5iw_2)) < ((NI)0) || ((NI)(TM__A04lj5tT6ly3Jo7R9ckk5iw_2)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__A04lj5tT6ly3Jo7R9ckk5iw_2), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}
...
appendString((&result.Field0), TM__A04lj5tT6ly3Jo7R9ckk5iw_14);
	...
	nimlf_(24, "D:\\nim\\compiler\\gorgeimpl.nim");
	{
		...
		if (((NI)(TM__A04lj5tT6ly3Jo7R9ckk5iw_15)) < ((NI)0) || ((NI)(TM__A04lj5tT6ly3Jo7R9ckk5iw_15)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__A04lj5tT6ly3Jo7R9ckk5iw_15), ((NI)0), ((NI)2147483647)); goto LA1_;
		}
...
appendString((&T7_), cache_p2);
		colontmpD__2 = T7_;
		secureHash__stdZsha49_u872(((colontmpD__2).p) ? (colontmpD__2.p->data) : NIM_NIL, colontmpD__2.len, h);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		nimln_(32);
		T8_.len = 0; T8_.p = NIM_NIL;
		colontmpD__3 = dollar___stdZsha49_u933(h);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 782358016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 2920404992)) {
				*nimErr_ = NIM_FALSE;
				nimlf_(52, "D:\\nim\\compiler\\gorgeimpl.nim");
				{
					...
					colontmpD__7 = getCurrentExceptionMsg__system_u7305();
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 782358016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 2920404992)) {
				...
				*nimErr_ = NIM_FALSE;
				...
				colontmpD__10 = getCurrentExceptionMsg__system_u7305();

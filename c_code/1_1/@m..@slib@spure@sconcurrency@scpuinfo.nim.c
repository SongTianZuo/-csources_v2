...
{	result = (NI)0;
	...
	Dl_2348810252_((&si));
	nimln_(63);
	if ((NI64)(si.dwNumberOfProcessors) < ((NI)(-2147483647 -1)) || (NI64)(si.dwNumberOfProcessors) > ((NI)2147483647)){ raiseRangeErrorI(si.dwNumberOfProcessors, ((NI)(-2147483647 -1)), ((NI)2147483647)); goto BeforeRet_;
	}

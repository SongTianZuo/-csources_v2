...
static N_INLINE(void, pluseq___pureZstrutils_u2478)(NF* x_p0, NF y_p1);
...
{nimErr_ = nimErrorFlag();
	...
	data = NIM_NIL;
	nimlf_(12, "D:\\nim\\compiler\\vmprofiler.nim");
	tLeave = cpuTime__pureZtimes_u4638();
...
LA11_: ;
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				pluseq___pureZstrutils_u2478((&(*T14_).time), ((NF)(tLeave) - (NF)((*prof_p0).tEnter)));
				nimln_(21);
				{

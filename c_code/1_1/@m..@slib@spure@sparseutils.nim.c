...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u7910)(NIM_CHAR* s_p0, NI s_p0Len_0);
...
LA7_: ;
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				output = (NI)((NI)((NU32)(output) << (NU32)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_7));
				nimln_(197);
				foundDigit = NIM_TRUE;
			}
			break;
			case 97 ... 102:
			{
				...
				output = (NI)((NI)((NU32)(output) << (NU32)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_9));
				nimln_(200);
				foundDigit = NIM_TRUE;
			}
			break;
			case 65 ... 70:
			{
				...
				output = (NI)((NI)((NU32)(output) << (NU32)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_11));
				nimln_(203);
				foundDigit = NIM_TRUE;
			}
			break;
...
LA10_: ;
		...
		T11_ = substr__system_u7910((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_34))-(((NI)0))+1);
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA16_: ;
				...
				nimln_(506);
				{
					...
					if (nimSubInt(((NI)2147483647), c, &TM__vI9aZNKIcImom6dDyKXW1ZA_37)) { raiseOverflow(); goto BeforeRet_;
					};

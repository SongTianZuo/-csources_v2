...
N_LIB_PRIVATE N_NIMCALL(tyEnum_FloatClass__E43KMm75mQr5blr7I2Y2aQ, classify__pureZmath_u156)(NF x_p0);
...
{	{
		...
		if (((NI)(TM__qENY1F9aF8k8WjeLE9cUs6Mw_16)) < ((NI)0) || ((NI)(TM__qENY1F9aF8k8WjeLE9cUs6Mw_16)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__qENY1F9aF8k8WjeLE9cUs6Mw_16), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	T1_ = classify__pureZmath_u156(f_p0);
...
LA3_: ;
	...
	{
		nimln_(64);
		addFloatRoundtrip__system_u4567((&result), f_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		nimln_(65);
		prepareAdd((&result), 0);
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(49, "D:\\nim\\compiler\\rodutils.nim");
	T1_ = (tyEnum_FloatClass__E43KMm75mQr5blr7I2Y2aQ)0;
	T1_ = classify__pureZmath_u156(((NF) (f_p0)));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	switch (T1_) {
	case ((tyEnum_FloatClass__E43KMm75mQr5blr7I2Y2aQ)4):
	{

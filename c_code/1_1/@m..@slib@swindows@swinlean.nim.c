...
typedef struct tyObject_GUID__lby9a6Ir4p9asVLKlerSWdyQ tyObject_GUID__lby9a6Ir4p9asVLKlerSWdyQ;
...
struct tyObject_GUID__lby9a6Ir4p9asVLKlerSWdyQ {
	NI32 D1;
	NI16 D2;
	NI16 D3;
...
N_LIB_PRIVATE N_NIMCALL(void*, symAddr__pureZdynlib_u62)(void* lib_p0, NCSTRING name_p1);
...
N_LIB_PRIVATE tyObject_GUID__lby9a6Ir4p9asVLKlerSWdyQ WSAID_CONNECTEX__windowsZwinlean_u720 = {((NI32)631375801), ((NI16)-8717), ((NI16)18016), {((NI8)-114),
((NI8)-23),
((NI8)118),
((NI8)-27),
((NI8)-116),
...
;
N_LIB_PRIVATE tyObject_GUID__lby9a6Ir4p9asVLKlerSWdyQ WSAID_ACCEPTEX__windowsZwinlean_u721 = {((NI32)-1254720015), ((NI16)-13396), ((NI16)4559), {((NI8)-107),
((NI8)-54),
((NI8)0),
((NI8)-128),
((NI8)95),
...
;
N_LIB_PRIVATE tyObject_GUID__lby9a6Ir4p9asVLKlerSWdyQ WSAID_GETACCEPTEXSOCKADDRS__windowsZwinlean_u722 = {((NI32)-1254720014), ((NI16)-13396), ((NI16)4559), {((NI8)-107),
((NI8)-54),
((NI8)0),
((NI8)-128),
((NI8)95),
...
;
N_LIB_PRIVATE tyProc__7LMcD5Rujqk7H2JqdJtoyA inet_ntop_real__windowsZwinlean_u793 = NIM_NIL;
N_LIB_PRIVATE void* ws2__windowsZwinlean_u794;
...
tyProc__DRixElKa6LQ9bEaY29bRSmsw Dl_1409286395_;
tyProc__ofoySXaAAlxxs9bQS9a1etlg Dl_1409286401_;
tyProc__9a9b4MhG9cyzdGMncqnn5oCMg Dl_1409286398_;
...
tyProc__5sqIMptsyAfPn3c9cPj4DOA Dl_1409286758_;
tyProc__aOhJuXP2rSFzW5eC9bSzvwg Dl_1409286410_;
tyProc__ubGMq5dTlL0KePX84o9aixw Dl_1409286263_;
tyProc__mBVOPXmpGfUrrbA9a5K9cMbQ Dl_1409286745_;
tyProc__M9auXaPiP9c2er0kVkWIwHaA Dl_1409286268_;
tyProc__Q9box9as0S1hHKH9cSO3MGDDA Dl_1409286750_;
tyProc__uryidYWkntM7ddjZSyxvyQ Dl_1409286749_;
tyProc__oew1DfaGl5XhHmnBK0HYXQ Dl_1409286734_;
tyProc__P13srMBg9b3d3yEV9aW4NCoA Dl_1409286249_;
tyProc__fadr6x6NQX6HSXuhBgqhyA Dl_1409286284_;
...
tyProc__eaOPsf1iOI9a9b5P7UjlcARg Dl_1409286442_;
...
tyProc__Dx0emMHXXGxkRnYGUaFLbg Dl_1409286696_;
...
nimErr_ = nimErrorFlag();
	...
	ws2__windowsZwinlean_u794 = T1_;
	nimln_(843);
	{
		void* T6_;
		if (!!((ws2__windowsZwinlean_u794 == NIM_NIL))) goto LA4_;
		nimln_(844);
		T6_ = (void*)0;
		T6_ = symAddr__pureZdynlib_u62(ws2__windowsZwinlean_u794, "inet_ntop");
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		inet_ntop_real__windowsZwinlean_u793 = ((tyProc__7LMcD5Rujqk7H2JqdJtoyA) (T6_));
	}
LA4_: ;
	BeforeRet_: ;
	popFrame();
...
if (!((TM__k6kyf4Co79a84IkK9blFuQVA_4 = nimLoadLibrary(TM__k6kyf4Co79a84IkK9blFuQVA_7))
	...
	Dl_1409286395_ = (tyProc__DRixElKa6LQ9bEaY29bRSmsw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "FindFirstFileW");
	Dl_1409286401_ = (tyProc__ofoySXaAAlxxs9bQS9a1etlg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "FindClose");
	Dl_1409286398_ = (tyProc__9a9b4MhG9cyzdGMncqnn5oCMg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "FindNextFileW");
	...
	Dl_1409286758_ = (tyProc__5sqIMptsyAfPn3c9cPj4DOA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "DeleteFileW");
	Dl_1409286410_ = (tyProc__aOhJuXP2rSFzW5eC9bSzvwg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "SetFileAttributesW");
	Dl_1409286263_ = (tyProc__ubGMq5dTlL0KePX84o9aixw) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "CreatePipe");
	Dl_1409286745_ = (tyProc__mBVOPXmpGfUrrbA9a5K9cMbQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "SetHandleInformation");
	Dl_1409286268_ = (tyProc__M9auXaPiP9c2er0kVkWIwHaA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "CreateNamedPipeW");
	Dl_1409286750_ = (tyProc__Q9box9as0S1hHKH9cSO3MGDDA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "CreateFileW");
	Dl_1409286749_ = (tyProc__uryidYWkntM7ddjZSyxvyQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "GetCurrentProcess");
	Dl_1409286734_ = (tyProc__oew1DfaGl5XhHmnBK0HYXQ) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "DuplicateHandle");
	Dl_1409286249_ = (tyProc__P13srMBg9b3d3yEV9aW4NCoA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "CloseHandle");
	Dl_1409286284_ = (tyProc__fadr6x6NQX6HSXuhBgqhyA) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "CreateProcessW");
	...
	Dl_1409286442_ = (tyProc__eaOPsf1iOI9a9b5P7UjlcARg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "GetSystemTimeAsFileTime");
	...
	Dl_1409286696_ = (tyProc__Dx0emMHXXGxkRnYGUaFLbg) nimGetProcAddr(TM__k6kyf4Co79a84IkK9blFuQVA_4, "WaitForMultipleObjects");

...
{nimErr_ = nimErrorFlag();
	nimlf_(39, "D:\\nim\\compiler\\ndi.nim");
	T1_ = (NIM_BOOL)0;
	T1_ = isEmpty__options_u5801(filename_p1);
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(611, "D:\\nim\\lib\\std\\syncio.nim");
	write__stdZsyncio_u256(f_p0, TM__9bjXlRg9ajY35u7ap75QbU6A_11);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();
...
appendString((&(*f_p0).buf), TM__9bjXlRg9ajY35u7ap75QbU6A_7);
	...
	write__stdZsyncio_u479((*f_p0).f, T2_, 2);
	...
	T3_[3] = (*f_p0).buf;
	writeLine__msgs_u465((*f_p0).f, T3_, 4);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	nimlf_(45, "D:\\nim\\compiler\\ndi.nim");
	{
		...
		nimln_(46);
		T5_ = (FILE*)0;
		T5_ = open__stdZsyncio_u590((*f_p0).filename, ((tyEnum_FileMode__9atfYUlw9bQtL4ixYGhUZZfQ)1), ((NI)8000));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		(*f_p0).f = T5_;
		nimln_(47);
		{

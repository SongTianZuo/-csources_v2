...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(17);
	liMessage__msgs_u1199(conf_p0, (*n_p1).info, ((tyEnum_TMsgKind__aghsq7zHWm205GRPJE9a2yw)17), colontmpD_, ((tyEnum_TErrorHandling__eXg3xAZwMffPDYOafyM3aQ)0), TM__Z829bJQuL5LjY0SVtwy0lEQ_10, NIM_FALSE);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	line = rawNewString(((NI)80));
	{
		...
		while (1) {
			...
			T4_ = (NIM_BOOL)0;
			T4_ = llStreamReadLine__llstream_u262(stdin_p1, (&line));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T4_) goto LA3;
...
LA9_: ;
				if (!T8_) goto LA10_;
				nimln_(59);
				llStreamWriteln__llstream_u294(result, stripped);
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			}
			goto LA6_;
LA10_: ;
			{
				nimln_(61);
				llStreamWriteln__llstream_u294(result, line);
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
			}
LA6_: ;
			{
	...
	nimlf_(62, "D:\\nim\\compiler\\filters.nim");
	llStreamClose__llstream_u170(stdin_p1);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
LA4_: ;
	...
	line = rawNewString(((NI)80));
	{
		...
		while (1) {
			...
			NimStringV2 colontmpD_;
			T8_ = (NIM_BOOL)0;
			T8_ = llStreamReadLine__llstream_u262(stdin_p1, (&line));
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
			if (!T8_) goto LA7;
			colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
			nimln_(71);
			...
			llStreamWriteln__llstream_u294(result, colontmpD_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA9_;
			{
				LA9_:;
			}

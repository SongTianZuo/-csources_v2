...
{nimErr_ = nimErrorFlag();
	...
	nimln_(30);
	colontmpD_ = splitFile__pathutils_u35(filename);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{	{
		...
		if (((NI)(TM__CHN2izqwZq7p9bLP6jv84NA_6)) < ((NI)0) || ((NI)(TM__CHN2izqwZq7p9bLP6jv84NA_6)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__CHN2izqwZq7p9bLP6jv84NA_6), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimlf_(1140, "D:\\nim\\compiler\\ast.nim");
	if (nimAddInt((NI)((NU32)(((NI) ((*xX60gensym8_).Sup.itemId.module))) << (NU32)(((NI)20))), ((NI) ((*xX60gensym8_).Sup.itemId.item)), &TM__CHN2izqwZq7p9bLP6jv84NA_8)) { raiseOverflow(); goto BeforeRet_;
	};

...
struct tySequence__OC4OxQhfzCBuUQxMi5llBQ_Content { NI cap; tyObject_StackTraceEntry__cwz3X1atIa8ET8VanDA2pw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4356)(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg* dest_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4365)(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4413)(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4422)(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4767)(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4776)(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4491)(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4500)(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4821)(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4830)(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u7975)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u7984)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4610)(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4619)(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4186)(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4195)(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw* dest_p0, void* env_p1);
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__WyH4kDTTwxjzV9brTg3MIsg_ = {.destructor = (void*)eqdestroy___system_u4356, .size = sizeof(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg), .align = (NI16) NIM_ALIGNOF(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_3, .traceImpl = (void*)eqtrace___system_u4365, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_8[4] = {3701606400, 1285336064, 1375453440, 2539992832};
N_LIB_PRIVATE TNimTypeV2 NTIv2__NJdlNxUmKiqDB6nnzMNJbQ_ = {.destructor = (void*)eqdestroy___system_u4413, .size = sizeof(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ), .align = (NI16) NIM_ALIGNOF(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_8, .traceImpl = (void*)eqtrace___system_u4422, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_9[5] = {3701606400, 1285336064, 1375453440, 1155872768, 205641216};
N_LIB_PRIVATE TNimTypeV2 NTIv2__PwxB1gj2RB604hR0Dczyzg_ = {.destructor = (void*)eqdestroy___system_u4767, .size = sizeof(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg), .align = (NI16) NIM_ALIGNOF(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg), .depth = 4, .display = TM__TzI3paKQY09cLjc9cmCvur3A_9, .traceImpl = (void*)eqtrace___system_u4776, .flags = 0};
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__e6AN4WVr2NKlqdq8x5qlFQ_ = {.destructor = (void*)eqdestroy___system_u4491, .size = sizeof(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ), .align = (NI16) NIM_ALIGNOF(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_12, .traceImpl = (void*)eqtrace___system_u4500, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_13[5] = {3701606400, 1285336064, 1375453440, 1155872768, 3774929920};
N_LIB_PRIVATE TNimTypeV2 NTIv2__59bEA3GZnnoahAU0veRzG6A_ = {.destructor = (void*)eqdestroy___system_u4821, .size = sizeof(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A), .align = (NI16) NIM_ALIGNOF(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A), .depth = 4, .display = TM__TzI3paKQY09cLjc9cmCvur3A_13, .traceImpl = (void*)eqtrace___system_u4830, .flags = 0};
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__4qtxOmDc9byiuSxzwS6BAmw_ = {.destructor = (void*)eqdestroy___system_u4610, .size = sizeof(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw), .align = (NI16) NIM_ALIGNOF(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_18, .traceImpl = (void*)eqtrace___system_u4619, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_19[4] = {3701606400, 1285336064, 1375453440, 2302286080};
N_LIB_PRIVATE TNimTypeV2 NTIv2__64k6GXy1HJpPQ8jVz2xjTw_ = {.destructor = (void*)eqdestroy___system_u4186, .size = sizeof(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw), .align = (NI16) NIM_ALIGNOF(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_19, .traceImpl = (void*)eqtrace___system_u4195, .flags = 0};
static N_INLINE(void, nimFrame)(TFrame* s_p0) {
	{

...
LA12_: ;
			...
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3628((&sVer2));
			eqdestroy___system_u3628((&sVer));
			goto BeforeRet_;
			{
				LA15_:;
			}
...
LA7_: ;
	...
	nimlf_(2004, "D:\\nim\\lib\\system.nim");
	eqwasMoved___system_u3625((&resultX60gensym40_));
	nimlf_(132, "D:\\nim\\compiler\\nimblecmd.nim");
	{
		NI T25_;
...
LA32_: ;
		...
		}
		{
			eqdestroy___stdZassertions_u16((&colontmpD__2));
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3628((&nimbleLinkLines));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
LA26_: ;
...
LA40_: ;
	...
	{
		nimlf_(2004, "D:\\nim\\lib\\system.nim");
		eqdestroy___system_u3628((&resultX60gensym40_));
		eqdestroy___system_u3628((&nimbleLinks));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");

...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u7940)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u7949)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0, void* env_p1);

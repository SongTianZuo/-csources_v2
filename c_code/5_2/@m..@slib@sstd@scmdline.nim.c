...
{	{
		...
		if (((NI)(TM__MZPGKsURfItHSi3RvnOT8Q_8)) < ((NI)0) || ((NI)(TM__MZPGKsURfItHSi3RvnOT8Q_8)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__MZPGKsURfItHSi3RvnOT8Q_8), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
LA12_: ;
		{
			...
			if (TM__MZPGKsURfItHSi3RvnOT8Q_12 < (-2147483647 -1) || TM__MZPGKsURfItHSi3RvnOT8Q_12 > 2147483647){ raiseOverflow(); goto LA8_;
			}
			nimlf_(9, "D:\\nim\\lib\\system\\indexerrors.nim");

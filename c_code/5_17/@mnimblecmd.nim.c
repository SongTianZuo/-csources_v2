...
{nimErr_ = nimErrorFlag();
	...
	nimln_(80);
	{
		...
		T5_ = substr__system_u7936(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_10));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA1_: ;
	...
	nimln_(90);
	{
		...
		T16_ = substr__system_u7924(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_16), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_17));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA14_: ;
	{
		...
		nimln_(96);
		{
			...
			T22_ = substr__system_u7924(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_19), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_20));
			nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA12_: ;
			...
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3616((&sVer2));
			eqdestroy___system_u3616((&sVer));
			goto BeforeRet_;
			{
				LA15_:;
			}
				...
				res = ((NI)0);
				{
					...
					while (1) {
						...
						nimln_(93);
						{
							NIM_BOOL T14_;
							T14_ = (NIM_BOOL)0;
							T14_ = eqeq___system_u7890(fX60gensym0_.gl_pathv[iX60gensym0_], ((NCSTRING) NIM_NIL));
							if (!!(!(T14_))) goto LA15_;
...
LA7_: ;
	...
	nimlf_(2004, "D:\\nim\\lib\\system.nim");
	eqwasMoved___system_u3613((&resultX60gensym40_));
	nimlf_(132, "D:\\nim\\compiler\\nimblecmd.nim");
	{
		NI T25_;
...
LA32_: ;
		...
		}
		{
			eqdestroy___stdZassertions_u16((&colontmpD__2));
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3616((&nimbleLinkLines));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
LA26_: ;
...
LA40_: ;
	...
	{
		nimlf_(2004, "D:\\nim\\lib\\system.nim");
		eqdestroy___system_u3616((&resultX60gensym40_));
		eqdestroy___system_u3616((&nimbleLinks));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");

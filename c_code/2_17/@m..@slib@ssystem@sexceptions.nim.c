...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u7977)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u7986)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__Vy6h1gTZNMhIMVGxEYGYlg_ = {.destructor = (void*)eqdestroy___system_u7977, .size = sizeof(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg), .align = (NI16) NIM_ALIGNOF(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_16, .traceImpl = (void*)eqtrace___system_u7986, .flags = 0};

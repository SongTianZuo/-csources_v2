...
{	{
		...
		if (((NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_8)) < ((NI)0) || ((NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_8)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_8), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}
...
LA18_: ;
				...
				T20_ = substr__system_u7885(colontmp_, firstX60gensym33_, (NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_17));
				nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");

...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u7849)(NIM_CHAR* s_p0, NI s_p0Len_0);
...
LA10_: ;
		...
		T11_ = substr__system_u7849((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_41))-(((NI)0))+1);
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");

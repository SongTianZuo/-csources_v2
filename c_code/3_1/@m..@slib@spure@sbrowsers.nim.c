...
{	{
		...
		if (((NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_6)) < ((NI)0) || ((NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_6)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__CZNeKGdQ8AWxD1HSDIq5DQ_6), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}

...
LA11_: ;
	...
	charsRead = llStreamRead__llstream_u244(T14_, ((void*) ((&(*L_p0).buf[toCopy]))), (NI)(TM__rZFvJ0pPfPjkF5gMPj0ilw_12));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimln_(90);
...
LA32_: ;
				{
					...
					nimln_(109);
					if (((*L_p0).bufLen) < ((NI)0) || ((*L_p0).bufLen) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((*L_p0).bufLen, ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
					}
...
LA37_: ;
					...
					T39_ = NIM_NIL;
					T39_ = (*L_p0).stream;
					charsRead = llStreamRead__llstream_u244(T39_, ((void*) ((&(*L_p0).buf[oldBufLen]))), oldBufLen);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					nimln_(114);
					{
...
{	result = (NI)0;
	...
	if ((NI)(TM__rZFvJ0pPfPjkF5gMPj0ilw_28) == (IL64(-9223372036854775807) - IL64(1))){ raiseOverflow(); goto BeforeRet_;
	}
...
{nimErr_ = nimErrorFlag();
	nimlf_(73, "D:\\nim\\compiler\\nimlexbase.nim");
	llStreamClose__llstream_u170((*L_p0).stream);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();

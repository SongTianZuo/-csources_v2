...
} TM__dje9awFf9c1DXjDuKVU9cWH6g_10 = { 6 | NIM_STRLIT_FLAG, "Users/" };
static const NimStringV2 TM__dje9awFf9c1DXjDuKVU9cWH6g_11 = {6, (NimStrPayload*)&TM__dje9awFf9c1DXjDuKVU9cWH6g_10};
static const struct {
  NI cap; NIM_CHAR data[7+1];
} TM__dje9awFf9c1DXjDuKVU9cWH6g_12 = { 7 | NIM_STRLIT_FLAG, "//user/" };
...
LA12_: ;
	...
	if (((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_4)) < ((NI)0) || ((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_4)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_4), ((NI)0), ((NI)IL64(9223372036854775807))); goto LA1_;
	}
	...
	T14_ = base_2;
	addNormalizePath__pureZpathnorm_u84(T14_, (&result), (&state), 92);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(85);
	T15_.len = 0; T15_.p = NIM_NIL;
	T15_ = f_p1;
	addNormalizePath__pureZpathnorm_u84(T15_, (&result), (&state), 92);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
LA5_: ;
	{
		...
		result = slash___stdZprivateZospaths50_u90(colontmpD__2, path_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto LA8_;
		{
			LA8_:;
		}
...
{	{
		...
		if (((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_7)) < ((NI)0) || ((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_7)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_7), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
LA12_: ;
	...
	if (((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_9)) < ((NI)0) || ((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_9)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_9), ((NI)0), ((NI)IL64(9223372036854775807))); goto LA1_;
	}
	...
	T16_ = f_p1;
	addNormalizePath__pureZpathnorm_u84(T16_, (&result), (&state), 92);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(108, "D:\\nim\\compiler\\pathutils.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = nsuContinuesWith(x_p0, TM__dje9awFf9c1DXjDuKVU9cWH6g_11, ((NI)3));
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!T3_) goto LA4_;
		nimln_(109);
		result = ((NI)3);
...
static N_INLINE(void, nimAddCharV1)(NimStringV2* s_p0, NIM_CHAR c_p1) {
	NI TM__dje9awFf9c1DXjDuKVU9cWH6g_15;
	NI TM__dje9awFf9c1DXjDuKVU9cWH6g_16;
{	prepareAdd(s_p0, ((NI)1));
	(*(*s_p0).p).data[(*s_p0).len] = c_p1;
	if (nimAddInt((*s_p0).len, ((NI)1), &TM__dje9awFf9c1DXjDuKVU9cWH6g_15)) { raiseOverflow(); goto BeforeRet_;
	};
	(*(*s_p0).p).data[(NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_15)] = 0;
	if (nimAddInt((*s_p0).len, ((NI)1), &TM__dje9awFf9c1DXjDuKVU9cWH6g_16)) { raiseOverflow(); goto BeforeRet_;
	};
	(*s_p0).len = (NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_16);
	}
BeforeRet_: ;
}
N_LIB_PRIVATE N_NIMCALL(NimStringV2, relevantPart__pathutils_u203)(NimStringV2 s_p0, NI afterSlashX_p1) {
	NimStringV2 result;
	NI TM__dje9awFf9c1DXjDuKVU9cWH6g_14;
	NI slashes;
	nimfr_("relevantPart", "D:\\nim\\compiler\\pathutils.nim");
{	result.len = 0; result.p = NIM_NIL;
	nimlf_(121, "D:\\nim\\compiler\\pathutils.nim");
	if (nimSubInt(s_p0.len, ((NI)8), &TM__dje9awFf9c1DXjDuKVU9cWH6g_14)) { raiseOverflow(); goto BeforeRet_;
	};
	if (((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_14)) < ((NI)0) || ((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_14)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_14), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
	}
	result = rawNewString(((NI) ((NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_14))));
	nimln_(122);
	slashes = afterSlashX_p1;
	{
		...
		i_2 = ((NI)0);
		{
			nimln_(120);
			while (1) {
				NI TM__dje9awFf9c1DXjDuKVU9cWH6g_18;
...
LA6_: ;
				{
					NI TM__dje9awFf9c1DXjDuKVU9cWH6g_17;
					nimln_(126);
					if (i < 0 || i >= s_p0.len){ raiseIndexError2(i,s_p0.len-1); goto BeforeRet_;
					}
					if (!((NU8)(s_p0.p->data[i]) == (NU8)(47))) goto LA9_;
					nimln_(127);
					if (nimSubInt(slashes, ((NI)1), &TM__dje9awFf9c1DXjDuKVU9cWH6g_17)) { raiseOverflow(); goto BeforeRet_;
					};
					slashes = (NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_17);
				}
				goto LA4_;
LA9_: ;
LA4_: ;
				nimlf_(122, "D:\\nim\\lib\\system\\iterators_1.nim");
				if (nimAddInt(i_2, ((NI)1), &TM__dje9awFf9c1DXjDuKVU9cWH6g_18)) { raiseOverflow(); goto BeforeRet_;
				};
				i_2 = (NI)(TM__dje9awFf9c1DXjDuKVU9cWH6g_18);
			} LA3: ;
		}
	}
	}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(143, "D:\\nim\\compiler\\pathutils.nim");
	{
		...
		colontmpD__2 = slash___stdZprivateZospaths50_u90(colontmpD_, x_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		colontmpD__3 = nsuReplaceChar(colontmpD__2, 92, 47);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		result = customPathImpl__pathutils_u220(colontmpD__3);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
LA4_: ;
	{
		...
		nimln_(147);
		{
			...
			nimln_(148);
			T14_.len = 0; T14_.p = NIM_NIL;
			colontmpD__4 = relevantPart__pathutils_u203(x_p0, slashes);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T14_ = rawNewString(colontmpD__4.len + 7);
appendString((&T14_), TM__dje9awFf9c1DXjDuKVU9cWH6g_13);
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	result = customPathImpl__pathutils_u220(colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{
		LA1_:;
	}

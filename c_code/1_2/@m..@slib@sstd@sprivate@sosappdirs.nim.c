...
} TM__XnRPlAiwKKY6TokjvYVCvw_10 = { 7 | NIM_STRLIT_FLAG, "APPDATA" };
static const NimStringV2 TM__XnRPlAiwKKY6TokjvYVCvw_11 = {7, (NimStrPayload*)&TM__XnRPlAiwKKY6TokjvYVCvw_10};
...
{	{
		...
		if (((NI)(TM__XnRPlAiwKKY6TokjvYVCvw_6)) < ((NI)0) || ((NI)(TM__XnRPlAiwKKY6TokjvYVCvw_6)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__XnRPlAiwKKY6TokjvYVCvw_6), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_ = getEnv__stdZenvvars_u32(TM__XnRPlAiwKKY6TokjvYVCvw_3, TM__XnRPlAiwKKY6TokjvYVCvw_5);
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	nimlf_(72, "D:\\nim\\lib\\std\\private\\osappdirs.nim");
	result = getEnv__stdZenvvars_u32(TM__XnRPlAiwKKY6TokjvYVCvw_11, TM__XnRPlAiwKKY6TokjvYVCvw_12);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimln_(75);
	normalizePathEnd__stdZprivateZospaths50_u22((&result), NIM_TRUE);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();

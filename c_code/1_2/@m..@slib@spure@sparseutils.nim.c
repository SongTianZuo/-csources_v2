...
N_LIB_PRIVATE N_NIMCALL(NI, rawParseUInt__pureZparseutils_u502)(NIM_CHAR* s_p0, NI s_p0Len_0, NU64* b_p1);
...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u7942)(NIM_CHAR* s_p0, NI s_p0Len_0);
N_LIB_PRIVATE N_NIMCALL(NI, parseSaturatedNatural__pureZparseutils_u447)(NIM_CHAR* s_p0, NI s_p0Len_0, NI* b_p1);
...
LA4_: ;
	{
		...
		if (nimAddInt(i, maxLen_p2, &TM__vI9aZNKIcImom6dDyKXW1ZA_2)) { raiseOverflow(); goto BeforeRet_;
		};
...
LA2_: ;
	...
	nimln_(190);
	{
		...
		T10_ = ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_3) < last);
		if (!(T10_)) goto LA11_;
...
LA11_: ;
		T9_ = T10_;
		if (!(T9_)) goto LA12_;
		if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_4)) { raiseOverflow(); goto BeforeRet_;
		};
...
LA12_: ;
		if (!T9_) goto LA13_;
		if (nimAddInt(i, ((NI)2), &TM__vI9aZNKIcImom6dDyKXW1ZA_5)) { raiseOverflow(); goto BeforeRet_;
		};
		i = (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_5);
	}
	goto LA7_;
LA13_: ;
	{
...
LA17_: ;
		if (!T16_) goto LA18_;
		if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_6)) { raiseOverflow(); goto BeforeRet_;
		};
		i = (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_6);
	}
	goto LA7_;
LA18_: ;
LA7_: ;
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				if (nimSubInt(((NU8)(s_p0[i])), ((NI)48), &TM__vI9aZNKIcImom6dDyKXW1ZA_7)) { raiseOverflow(); goto BeforeRet_;
				};
				output = (NI)((NI)((NU64)(output) << (NU64)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_7));
				nimln_(197);
				foundDigit = NIM_TRUE;
			}
			break;
			case 97 ... 102:
			{
				...
				if (nimSubInt(((NU8)(s_p0[i])), ((NI)97), &TM__vI9aZNKIcImom6dDyKXW1ZA_8)) { raiseOverflow(); goto BeforeRet_;
				};
				if (nimAddInt((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_8), ((NI)10), &TM__vI9aZNKIcImom6dDyKXW1ZA_9)) { raiseOverflow(); goto BeforeRet_;
				};
				output = (NI)((NI)((NU64)(output) << (NU64)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_9));
				nimln_(200);
				foundDigit = NIM_TRUE;
			}
			break;
			case 65 ... 70:
			{
				...
				if (nimSubInt(((NU8)(s_p0[i])), ((NI)65), &TM__vI9aZNKIcImom6dDyKXW1ZA_10)) { raiseOverflow(); goto BeforeRet_;
				};
				if (nimAddInt((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_10), ((NI)10), &TM__vI9aZNKIcImom6dDyKXW1ZA_11)) { raiseOverflow(); goto BeforeRet_;
				};
				output = (NI)((NI)((NU64)(output) << (NU64)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_11));
				nimln_(203);
				foundDigit = NIM_TRUE;
			}
			break;
			...
			nimln_(205);
			if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_12)) { raiseOverflow(); goto BeforeRet_;
			};
...
LA7_: ;
		{
			...
			nimln_(434);
			if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_14)) { raiseOverflow(); goto BeforeRet_;
			};
...
LA21_: ;
				...
				if (nimSubInt(((NU8)(s_p0[i])), ((NI)48), &TM__vI9aZNKIcImom6dDyKXW1ZA_15)) { raiseOverflow(); goto BeforeRet_;
				};
				...
				nimln_(440);
				{
					...
					if (nimAddInt64((IL64(-9223372036854775807) - IL64(1)), ((NI64) (c)), &TM__vI9aZNKIcImom6dDyKXW1ZA_16)) { raiseOverflow(); goto BeforeRet_;
					};
					...
					if (nimSubInt64((NI64)(TM__vI9aZNKIcImom6dDyKXW1ZA_17), ((NI64) (c)), &TM__vI9aZNKIcImom6dDyKXW1ZA_18)) { raiseOverflow(); goto BeforeRet_;
					};
...
LA30_: ;
						if (!T29_) goto LA28;
						if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_22)) { raiseOverflow(); goto BeforeRet_;
						};
...
LA35_: ;
		{
			...
			nimln_(449);
			if (nimMulInt64((*b_p1), sign, &TM__vI9aZNKIcImom6dDyKXW1ZA_23)) { raiseOverflow(); goto BeforeRet_;
			};
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(519);
	{
		...
		T3_ = (NIM_BOOL)0;
		T4_ = (NIM_BOOL)0;
		if (nimSubInt(s_p0Len_0, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_24)) { raiseOverflow(); goto BeforeRet_;
		};
		T4_ = (i < (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_24));
		if (!(T4_)) goto LA5_;
		if (i < 0 || i >= s_p0Len_0){ raiseIndexError2(i,s_p0Len_0-1); goto BeforeRet_;
		}
...
LA5_: ;
		T3_ = T4_;
		if (!(T3_)) goto LA6_;
		if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_25)) { raiseOverflow(); goto BeforeRet_;
		};
		if ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_25) < 0 || (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_25) >= s_p0Len_0){ raiseIndexError2((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_25),s_p0Len_0-1); goto BeforeRet_;
		}
		T3_ = (((NU8)(s_p0[(NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_25)])) >= ((NU8)(48)) && ((NU8)(s_p0[(NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_25)])) <= ((NU8)(57)));
LA6_: ;
		if (!T3_) goto LA7_;
		nimln_(520);
		integerOutOfRangeError__pureZparseutils_u325();
...
LA12_: ;
		if (!T11_) goto LA13_;
		if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_26)) { raiseOverflow(); goto BeforeRet_;
		};
...
LA24_: ;
				...
				if (nimSubInt(((NU8)(s_p0[i])), ((NI)48), &TM__vI9aZNKIcImom6dDyKXW1ZA_27)) { raiseOverflow(); goto BeforeRet_;
				};
				res = (NU64)((NU64)((NU64)((NU64)(res) * (NU64)(10ULL))) + (NU64)(((NU64) ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_27)))));
				nimln_(527);
				{
...
{nimErr_ = nimErrorFlag();
	...
	res = 0ULL;
	nimln_(548);
	result = rawParseUInt__pureZparseutils_u502(s_p0, s_p0Len_0, (&res));
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimln_(549);
	{
		if (!!((result == ((NI)0)))) goto LA3_;
	...
	setLengthStrV2((&(*token_p1)), ((NI) (length_p2)));
	{
		...
		i_2 = ((NI)0);
		{
			...
			while (1) {
				...
				nimlf_(122, "D:\\nim\\lib\\system\\iterators_1.nim");
				if (nimAddInt(i_2, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_30)) { raiseOverflow(); goto BeforeRet_;
				};
...
LA8_: ;
		{
			...
			nimln_(484);
			if (nimSubInt((*cell).rc, ((NI)16), &TM__vI9aZNKIcImom6dDyKXW1ZA_31)) { raiseOverflow(); goto BeforeRet_;
			};
			(*cell).rc = (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_31);
		}
LA6_: ;
		nimln_(486);
...
N_LIB_PRIVATE N_NIMCALL(NI, parseBiggestFloat__pureZparseutils_u969)(NimStringV2 s_p0, NF* number_p1, NI start_p2) {
	NI result;
NIM_BOOL* nimErr_;
...
LA10_: ;
		...
		nimlf_(226, "D:\\nim\\lib\\pure\\parseutils.nim");
		if (nimSubInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_34)) { raiseOverflow(); goto BeforeRet_;
		};
		if ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_34)-((NI)0) != -1 && (((NI)0) < 0 || ((NI)0) >= s_p0Len_0 || (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_34) < 0 || (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_34) >= s_p0Len_0)){ raiseIndexError4(((NI)0), (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_34), s_p0Len_0); goto BeforeRet_;
		}
		T11_.len = 0; T11_.p = NIM_NIL;
		T11_ = substr__system_u7942((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_34))-(((NI)0))+1);
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA16_: ;
				...
				if (nimSubInt(((NU8)(s_p0[i])), ((NI)48), &TM__vI9aZNKIcImom6dDyKXW1ZA_36)) { raiseOverflow(); goto BeforeRet_;
				};
				c = (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_36);
				nimln_(506);
				{
					NI TM__vI9aZNKIcImom6dDyKXW1ZA_37;
					NI TM__vI9aZNKIcImom6dDyKXW1ZA_38;
					NI TM__vI9aZNKIcImom6dDyKXW1ZA_39;
					if (nimSubInt(((NI)IL64(9223372036854775807)), c, &TM__vI9aZNKIcImom6dDyKXW1ZA_37)) { raiseOverflow(); goto BeforeRet_;
					};
					if (!((*b_p1) <= (NI)((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_37) / ((NI)10)))) goto LA19_;
					nimln_(507);
					if (nimMulInt((*b_p1), ((NI)10), &TM__vI9aZNKIcImom6dDyKXW1ZA_38)) { raiseOverflow(); goto BeforeRet_;
					};
					if (nimAddInt((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_38), c, &TM__vI9aZNKIcImom6dDyKXW1ZA_39)) { raiseOverflow(); goto BeforeRet_;
					};
					(*b_p1) = (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_39);
				}
				goto LA17_;
LA19_: ;
				{
...
LA25_: ;
						if (!T24_) goto LA23;
						if (nimAddInt(i, ((NI)1), &TM__vI9aZNKIcImom6dDyKXW1ZA_41)) { raiseOverflow(); goto BeforeRet_;
						};
						i = (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_41);
					} LA23: ;
				}
			} LA14: ;
		}
...
{nimErr_ = nimErrorFlag();
	...
	result = parseSaturatedNatural__pureZparseutils_u447((((s_p0).p) ? ((NIM_CHAR*)s_p0.p->data+(start_p2)) : NIM_NIL), ((s_p0.len-1))-(start_p2)+1, b_p1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();

...
struct tySequence__OC4OxQhfzCBuUQxMi5llBQ_Content { NI cap; tyObject_StackTraceEntry__cwz3X1atIa8ET8VanDA2pw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4358)(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg* dest_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4367)(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4415)(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4424)(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4769)(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4778)(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4493)(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4502)(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u8035)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u8044)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4823)(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4832)(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___stdZoserrors_u55)(tyObject_OSError__364R2OEHwjKXXXZy8WY36g* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___stdZoserrors_u64)(tyObject_OSError__364R2OEHwjKXXXZy8WY36g* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___stdZsyncio_u103)(tyObject_EOFError__FAA9ashm5tcoAUjV9adjIF0Q* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___stdZsyncio_u112)(tyObject_EOFError__FAA9ashm5tcoAUjV9adjIF0Q* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4612)(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4621)(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4188)(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4197)(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw* dest_p0, void* env_p1);
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__WyH4kDTTwxjzV9brTg3MIsg_ = {.destructor = (void*)eqdestroy___system_u4358, .size = sizeof(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg), .align = (NI16) NIM_ALIGNOF(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_3, .traceImpl = (void*)eqtrace___system_u4367, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_8[4] = {3701606400, 1285336064, 1375453440, 2539992832};
N_LIB_PRIVATE TNimTypeV2 NTIv2__NJdlNxUmKiqDB6nnzMNJbQ_ = {.destructor = (void*)eqdestroy___system_u4415, .size = sizeof(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ), .align = (NI16) NIM_ALIGNOF(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_8, .traceImpl = (void*)eqtrace___system_u4424, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_9[5] = {3701606400, 1285336064, 1375453440, 1155872768, 205641216};
N_LIB_PRIVATE TNimTypeV2 NTIv2__PwxB1gj2RB604hR0Dczyzg_ = {.destructor = (void*)eqdestroy___system_u4769, .size = sizeof(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg), .align = (NI16) NIM_ALIGNOF(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg), .depth = 4, .display = TM__TzI3paKQY09cLjc9cmCvur3A_9, .traceImpl = (void*)eqtrace___system_u4778, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_10[4] = {3701606400, 1285336064, 1375453440, 2685264128};
N_LIB_PRIVATE TNimTypeV2 NTIv2__e6AN4WVr2NKlqdq8x5qlFQ_ = {.destructor = (void*)eqdestroy___system_u4493, .size = sizeof(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ), .align = (NI16) NIM_ALIGNOF(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_10, .traceImpl = (void*)eqtrace___system_u4502, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_11[4] = {3701606400, 1285336064, 1375453440, 3623119360};
N_LIB_PRIVATE TNimTypeV2 NTIv2__3Nf0agRDkt9a349bK2N7oP7A_ = {.destructor = (void*)eqdestroy___stdZassertions_u228, .size = sizeof(tyObject_AssertionDefect__3Nf0agRDkt9a349bK2N7oP7A), .align = (NI16) NIM_ALIGNOF(tyObject_AssertionDefect__3Nf0agRDkt9a349bK2N7oP7A), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_11, .traceImpl = (void*)eqtrace___stdZassertions_u237, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_12[5] = {3701606400, 1285336064, 502999040, 103939072, 3899209984};
...
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_13[4] = {3701606400, 1285336064, 502999040, 782358016};
N_LIB_PRIVATE TNimTypeV2 NTIv2__Vy6h1gTZNMhIMVGxEYGYlg_ = {.destructor = (void*)eqdestroy___system_u8035, .size = sizeof(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg), .align = (NI16) NIM_ALIGNOF(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_13, .traceImpl = (void*)eqtrace___system_u8044, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_14[5] = {3701606400, 1285336064, 1375453440, 1155872768, 3774929920};
N_LIB_PRIVATE TNimTypeV2 NTIv2__59bEA3GZnnoahAU0veRzG6A_ = {.destructor = (void*)eqdestroy___system_u4823, .size = sizeof(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A), .align = (NI16) NIM_ALIGNOF(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A), .depth = 4, .display = TM__TzI3paKQY09cLjc9cmCvur3A_14, .traceImpl = (void*)eqtrace___system_u4832, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_15[4] = {3701606400, 1285336064, 502999040, 103939072};
N_LIB_PRIVATE TNimTypeV2 NTIv2__2gYx9cExnvfgU7mT8iWh7Mg_ = {.destructor = (void*)eqdestroy___pureZparseutils_u330, .size = sizeof(tyObject_ValueError__2gYx9cExnvfgU7mT8iWh7Mg), .align = (NI16) NIM_ALIGNOF(tyObject_ValueError__2gYx9cExnvfgU7mT8iWh7Mg), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_15, .traceImpl = (void*)eqtrace___pureZparseutils_u339, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_16[4] = {3701606400, 1285336064, 502999040, 2920404992};
N_LIB_PRIVATE TNimTypeV2 NTIv2__364R2OEHwjKXXXZy8WY36g_ = {.destructor = (void*)eqdestroy___stdZoserrors_u55, .size = sizeof(tyObject_OSError__364R2OEHwjKXXXZy8WY36g), .align = (NI16) NIM_ALIGNOF(tyObject_OSError__364R2OEHwjKXXXZy8WY36g), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_16, .traceImpl = (void*)eqtrace___stdZoserrors_u64, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_17[5] = {3701606400, 1285336064, 502999040, 782358016, 4043264};
N_LIB_PRIVATE TNimTypeV2 NTIv2__FAA9ashm5tcoAUjV9adjIF0Q_ = {.destructor = (void*)eqdestroy___stdZsyncio_u103, .size = sizeof(tyObject_EOFError__FAA9ashm5tcoAUjV9adjIF0Q), .align = (NI16) NIM_ALIGNOF(tyObject_EOFError__FAA9ashm5tcoAUjV9adjIF0Q), .depth = 4, .display = TM__TzI3paKQY09cLjc9cmCvur3A_17, .traceImpl = (void*)eqtrace___stdZsyncio_u112, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_18[4] = {3701606400, 1285336064, 1375453440, 2876324352};
N_LIB_PRIVATE TNimTypeV2 NTIv2__4qtxOmDc9byiuSxzwS6BAmw_ = {.destructor = (void*)eqdestroy___system_u4612, .size = sizeof(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw), .align = (NI16) NIM_ALIGNOF(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_18, .traceImpl = (void*)eqtrace___system_u4621, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_19[4] = {3701606400, 1285336064, 1375453440, 2302286080};
N_LIB_PRIVATE TNimTypeV2 NTIv2__64k6GXy1HJpPQ8jVz2xjTw_ = {.destructor = (void*)eqdestroy___system_u4188, .size = sizeof(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw), .align = (NI16) NIM_ALIGNOF(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_19, .traceImpl = (void*)eqtrace___system_u4197, .flags = 0};
static N_INLINE(void, nimFrame)(TFrame* s_p0) {
	{
...
{	nimlf_(20, "D:\\nim\\lib\\system\\cellseqs_v2.nim");
	{
		...
		nimln_(25);
		if (nimMulInt((*s_p0).cap, ((NI)16), &TM__TzI3paKQY09cLjc9cmCvur3A_5)) { raiseOverflow(); goto BeforeRet_;
		};
		if (((NI)(TM__TzI3paKQY09cLjc9cmCvur3A_5)) < ((NI)0) || ((NI)(TM__TzI3paKQY09cLjc9cmCvur3A_5)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__TzI3paKQY09cLjc9cmCvur3A_5), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
		T5_ = (void*)0;
		T5_ = allocImpl__system_u1736(((NI) ((NI)(TM__TzI3paKQY09cLjc9cmCvur3A_5))));
		d = ((tyTuple__N4J9cV4JZGem3ljqqj5rT0Q*) (T5_));
		nimln_(26);
		if (nimMulInt((*s_p0).len, ((NI)16), &TM__TzI3paKQY09cLjc9cmCvur3A_6)) { raiseOverflow(); goto BeforeRet_;
		};
		if (((NI)(TM__TzI3paKQY09cLjc9cmCvur3A_6)) < ((NI)0) || ((NI)(TM__TzI3paKQY09cLjc9cmCvur3A_6)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__TzI3paKQY09cLjc9cmCvur3A_6), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}

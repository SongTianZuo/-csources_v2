...
struct tySequence__OC4OxQhfzCBuUQxMi5llBQ_Content { NI cap; tyObject_StackTraceEntry__cwz3X1atIa8ET8VanDA2pw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__364R2OEHwjKXXXZy8WY36g*, newOSError__stdZoserrors_u48)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1);
N_LIB_PRIVATE N_NIMCALL(void*, nimNewObj)(NI size_p0, NI alignment_p1);
N_LIB_PRIVATE N_NIMCALL(NimStringV2, osErrorMsg__stdZoserrors_u9)(NI32 errorCode_p0);
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(51);
	{
		...
		nimln_(53);
		{
			...
			nimln_(53);
			T7_ = (NI32)0;
			T7_ = Dl_1409286318_(((NI32)4864), NIM_NIL, errorCode_p0, ((NI32)0), ((void*) (&msgbuf)), ((NI32)0), NIM_NIL);
			if (!!((T7_ == ((NI32)0)))) goto LA8_;
			nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
			nimlf_(55, "D:\\nim\\lib\\std\\oserrors.nim");
			T10_.len = 0; T10_.p = NIM_NIL;
			T10_ = dollar___stdZwidestrs_u372(msgbuf);
...
{	{
		...
		if (((NI)(TM__1nRK0qvLEFLABF9aZnNtAXQ_9)) < ((NI)0) || ((NI)(TM__1nRK0qvLEFLABF9aZnNtAXQ_9)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__1nRK0qvLEFLABF9aZnNtAXQ_9), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	(*T1_).Sup.Sup.message = osErrorMsg__stdZoserrors_u9(errorCode_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = T1_;
	nimln_(79);
	{
		...
		nimln_(80);
		{
			...
			if (!(T8_)) goto LA9_;
			T10_ = (NIM_CHAR*)0;
			T10_ = X5BX5D___system_u7475((&(*result).Sup.Sup.message), ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T8_ = !(((NU8)((*T10_)) == (NU8)(10)));
LA9_: ;
			if (!T8_) goto LA11_;
...
{nimErr_ = nimErrorFlag();
	nimlf_(92, "D:\\nim\\lib\\std\\oserrors.nim");
	T1_ = NIM_NIL;
	T1_ = newOSError__stdZoserrors_u48(errorCode_p0, additionalInfo_p1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;

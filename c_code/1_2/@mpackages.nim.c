...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(29, "D:\\nim\\compiler\\packages.nim");
	filename = toFullPath__msgs_u607(conf_p0, fileIdx_p2);
	...
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(31);
	info = newLineInfo__msgs_u414(fileIdx_p2, ((NI)1), ((NI)1));
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(32);
	pkgName = getPackageName__options_u5430(conf_p0, filename);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	nimln_(33);

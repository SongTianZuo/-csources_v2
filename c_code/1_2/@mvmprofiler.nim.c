...
static N_INLINE(void, pluseq___pureZstrutils_u2494)(NF* x_p0, NF y_p1);
...
{nimErr_ = nimErrorFlag();
	...
	data = NIM_NIL;
	nimlf_(12, "D:\\nim\\compiler\\vmprofiler.nim");
	tLeave = cpuTime__pureZtimes_u4654();
...
LA11_: ;
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
				pluseq___pureZstrutils_u2494((&(*T14_).time), ((NF)(tLeave) - (NF)((*prof_p0).tEnter)));
				nimln_(21);
				{
...
{	{
		...
		if (((NI)(TM__Ai9anooT0gIYA9c9b30PXqgdQ_10)) < ((NI)0) || ((NI)(TM__Ai9anooT0gIYA9c9b30PXqgdQ_10)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__Ai9anooT0gIYA9c9b30PXqgdQ_10), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
LA27_: ;
				...
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;
				nimln_(44);
				colontmpD__5 = toFileLineCol__msgs_u694(conf_p0, flMax);
				if (NIM_UNLIKELY(*nimErr_)) goto LA5_;

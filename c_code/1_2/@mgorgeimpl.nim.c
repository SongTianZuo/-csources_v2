...
{nimErr_ = nimErrorFlag();
	...
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	nimlf_(29, "D:\\nim\\compiler\\gorgeimpl.nim");
	colontmpD_ = toFullPath__msgs_u607(conf_p4, info_p3.fileIndex);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
appendString((&T8_), colontmpD__3);
		colontmpD__4 = T8_;
		filename = toGeneratedFile__options_u5510(conf_p4, colontmpD__4, TM__A04lj5tT6ly3Jo7R9ckk5iw_10);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		f = (FILE*)0;
		nimln_(34);
		{
			...
			if (!(T11_)) goto LA12_;
			T11_ = open__stdZsyncio_u559(&f, filename, ((tyEnum_FileMode__9atfYUlw9bQtL4ixYGhUZZfQ)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
LA12_: ;
			if (!T11_) goto LA13_;
			colontmp_.len = 0; colontmp_.p = NIM_NIL;
			nimln_(35);
			colontmp_ = readAll__stdZsyncio_u508(f);
...
LA24_: ;
		...
		nimln_(49);
		{
			...
			nimln_(50);
			writeFile__stdZsyncio_u645(filename, result.Field0);
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		}
LA34_: ;
		{
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 782358016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 2920404992)) {
				*nimErr_ = NIM_FALSE;
				nimlf_(52, "D:\\nim\\compiler\\gorgeimpl.nim");
				{
					...
					colontmpD__7 = getCurrentExceptionMsg__system_u7321();
...
LA55_: ;
		...
		{
			nimlf_(131, "D:\\nim\\lib\\system\\seqs_v2.nim");
			eqdestroy___pureZosproc_u223(&p_2);
		}
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 782358016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 2920404992)) {
				...
				*nimErr_ = NIM_FALSE;
				...
				colontmpD__10 = getCurrentExceptionMsg__system_u7321();

...
{	{
		...
		if (((NI)(TM__XmvBE1RAE2EQK439c31duVQ_4)) < ((NI)0) || ((NI)(TM__XmvBE1RAE2EQK439c31duVQ_4)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__XmvBE1RAE2EQK439c31duVQ_4), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(37);
	{
		...
		T8_ = toFileLineCol__msgs_u694(conf_p0, (*disc_p2).info);
...
appendString((&(*result_p0)), colontmpD_);
	nimln_(23);
	{
		...
		nimln_(24);
		T8_.len = 0; T8_.p = NIM_NIL;
		colontmpD__2 = toFileLineCol__msgs_u694(conf_p1, (*(*typ_2).sym).info);
		if (NIM_UNLIKELY(*nimErr_)) goto LA7_;

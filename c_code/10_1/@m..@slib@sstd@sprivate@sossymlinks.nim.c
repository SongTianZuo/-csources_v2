...
{nimErr_ = nimErrorFlag();
	nimlf_(56, "D:\\nim\\lib\\std\\private\\ossymlinks.nim");
	{
		...
		nimln_(57);
		T7_ = (NI32)0;
		T7_ = osLastError__stdZoserrors_u85();
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		T8_.Field0 = src_p0;
		T8_.Field1 = dest_p1;
		colontmpD_ = dollar___stdZprivateZoscommon_u108(T8_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		raiseOSError__stdZoserrors_u82(T7_, colontmpD_);
		if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
		{
			LA6_:;
		}
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(71);
	{
		...
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_u82(T5_, symlinkPath_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA3_: ;
	nimln_(73);
	{
		...
		if (((NI)(TM__t9biqTXYx29brpMWSIVql20w_2)) < ((NI)0) || ((NI)(TM__t9biqTXYx29brpMWSIVql20w_2)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__t9biqTXYx29brpMWSIVql20w_2), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}

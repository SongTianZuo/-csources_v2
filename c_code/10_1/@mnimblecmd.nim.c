...
N_LIB_PRIVATE N_NIMCALL(tyTuple__7q7q3E6Oj24ZNVJb9aonhAg, getPathVersionChecksum__nimblecmd_u202)(NimStringV2 p_p0);
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(80);
	{
		...
		T5_ = substr__system_u7914(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_10));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA1_: ;
	...
	nimln_(90);
	{
		...
		T16_ = substr__system_u7902(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_16), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_17));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA14_: ;
	{
		...
		nimln_(96);
		{
			...
			T22_ = substr__system_u7902(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_19), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_20));
			nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
{	{
		...
		if (((NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_28)) < ((NI)0) || ((NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_28)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_28), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(106, "D:\\nim\\compiler\\nimblecmd.nim");
	tmpTuple = getPathVersionChecksum__nimblecmd_u202(p_p2);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	...
	nimlf_(107, "D:\\nim\\compiler\\nimblecmd.nim");
	{
		...
		nimln_(109);
		{
			...
			NIM_BOOL T12_;
			T10_ = (NIM_BOOL)0;
			colontmpD_ = getOrDefault__nimblecmd_u314((*packages_p1), name);
			if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				...
				res = ((NI)0);
				{
					...
					while (1) {
						...
						nimln_(93);
						{
							NIM_BOOL T14_;
							T14_ = (NIM_BOOL)0;
							T14_ = eqeq___system_u7868(fX60gensym0_.gl_pathv[iX60gensym0_], ((NCSTRING) NIM_NIL));
							if (!!(!(T14_))) goto LA15_;

...
{	{
		...
		if (((NI)(TM__VzbRQH9cb1xm1tSKH4PwBSw_9)) < ((NI)0) || ((NI)(TM__VzbRQH9cb1xm1tSKH4PwBSw_9)) > ((NI)2147483647)){ raiseRangeErrorI((NI)(TM__VzbRQH9cb1xm1tSKH4PwBSw_9), ((NI)0), ((NI)2147483647)); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(82, "D:\\nim\\lib\\pure\\uri.nim");
	if (nimAddInt(s_p0.len, (NI)((NI32)(s_p0.len) >> (NU32)(((NI)2))), &TM__VzbRQH9cb1xm1tSKH4PwBSw_2)) { raiseOverflow(); goto BeforeRet_;
	};

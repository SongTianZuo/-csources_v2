...
{	result = (NI)0;
	...
	nimlf_(85, "D:\\nim\\lib\\pure\\concurrency\\cpuinfo.nim");
	{
		...
		nimln_(86);
		if ((NI64)(sysinfo.cpu_count) < ((NI)(-2147483647 -1)) || (NI64)(sysinfo.cpu_count) > ((NI)2147483647)){ raiseRangeErrorI(sysinfo.cpu_count, ((NI)(-2147483647 -1)), ((NI)2147483647)); goto BeforeRet_;
		}

...
LA17_: ;
	{
		...
		nimlf_(239, "D:\\nim\\lib\\std\\private\\osfiles.nim");
		{
			...
			NI32 T28_;
			T25_ = (NIM_BOOL)0;
			T25_ = open__stdZsyncio_u401(&s, source_p0, ((tyEnum_FileMode__9atfYUlw9bQtL4ixYGhUZZfQ)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T25_)) goto LA26_;
			T28_ = (NI32)0;
			T28_ = osLastError__stdZoserrors_u85();
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_u82(T28_, source_p0);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
LA26_: ;
		nimln_(240);
		{
			...
			NI32 T34_;
			T31_ = (NIM_BOOL)0;
			T31_ = open__stdZsyncio_u401(&d, dest_p1, ((tyEnum_FileMode__9atfYUlw9bQtL4ixYGhUZZfQ)1), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T31_)) goto LA32_;
			nimln_(241);
			close__stdZsyncio_u251(s);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			nimln_(242);
			T34_ = (NI32)0;
			T34_ = osLastError__stdZoserrors_u85();
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			raiseOSError__stdZoserrors_u82(T34_, dest_p1);
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		}
LA32_: ;
		nimln_(243);
		buf = allocImpl__system_u1736(((NI)8000));
		{
			...
			while (1) {
				...
				nimln_(246);
				{
					...
					nimln_(247);
					if ((bytesread) < ((NI)0) || (bytesread) > ((NI)2147483647)){ raiseRangeErrorI(bytesread, ((NI)0), ((NI)2147483647)); goto BeforeRet_;
					}
					...
					nimln_(248);
					{
						...
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						nimln_(251);
						close__stdZsyncio_u251(d);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						nimln_(252);
						T45_ = (NI32)0;
						T45_ = osLastError__stdZoserrors_u85();
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
						raiseOSError__stdZoserrors_u82(T45_, dest_p1);
						if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
					}
LA43_: ;
				}
...
LA41_: ;
	{
		nimln_(133);
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			raiseOSError__stdZoserrors_u82(T50_, colontmpD_);
			if (NIM_UNLIKELY(*nimErr_)) goto LA49_;
			{
				LA49_:;
			}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(73, "D:\\nim\\lib\\std\\private\\osfiles.nim");
	{
		...
		T6_ = osLastError__stdZoserrors_u85();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_u82(T6_, filename_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA4_: ;
	nimln_(74);

...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryMoveFSObject__stdZprivateZoscommon_u98)(NimStringV2 source_p0, NimStringV2 dest_p1, NIM_BOOL isDir_p2);
...
LA45_: ;
							...
							T50_ = substr__system_u7885(dir_p0, ((NI)0), i);
							nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
{nimErr_ = nimErrorFlag();
	nimlf_(543, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = tryMoveFSObject__stdZprivateZoscommon_u98(source_p0, dest_p1, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		nimln_(545);

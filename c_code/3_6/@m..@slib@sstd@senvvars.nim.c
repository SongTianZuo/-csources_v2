...
N_LIB_PRIVATE N_NIMCALL(void, setLen__stdZenvvars_u118)(tySequence__4eQHGndY6XBYpFOH09apV8Q* s_p0, NI newlen_p1);
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(97);
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = eqeq___system_u7843(env, ((NCSTRING) NIM_NIL));
		if (!T3_) goto LA4_;
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	T2_ = (NIM_BOOL)0;
	T2_ = eqeq___system_u7843(T1_, ((NCSTRING) NIM_NIL));
	result = !(T2_);
	}
BeforeRet_: ;
	popFrame();
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___stdZenvvars_u109)(tySequence__4eQHGndY6XBYpFOH09apV8Q* dest_p0, void* env_p1) {
}
N_LIB_PRIVATE N_NIMCALL(void, eqcopy___stdZenvvars_u103)(tySequence__4eQHGndY6XBYpFOH09apV8Q* dest_p0, tySequence__4eQHGndY6XBYpFOH09apV8Q src_p1) {
	...
	NI colontmp_;
	T1_ = src_p1.len;
	setLen__stdZenvvars_u118((&(*dest_p0)), T1_);
	colontmp_ = ((NI)0);
	{
		while (1) {
			NI T4_;
...
N_LIB_PRIVATE N_NIMCALL(void, eqsink___stdZenvvars_u106)(tySequence__4eQHGndY6XBYpFOH09apV8Q* dest_p0, tySequence__4eQHGndY6XBYpFOH09apV8Q src_p1) {
	if ((*dest_p0).p != src_p1.p) {	eqdestroy___stdZenvvars_u100(dest_p0);
	}

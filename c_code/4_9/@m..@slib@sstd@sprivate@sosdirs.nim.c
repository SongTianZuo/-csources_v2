...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__stdZprivateZosdirs_u502)(NimStringV2 dir_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_u495)(NimStringV2 dir_p0);
...
LA3_: ;
	{
		nimln_(374);
		if ((EEXIST) < ((NI)0) || (EEXIST) > ((NI)65535)){ raiseRangeErrorI(EEXIST, ((NI)0), ((NI)65535)); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(418, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__stdZprivateZosdirs_u502(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	nimln_(419);
	{
...
LA45_: ;
							...
							T50_ = substr__system_u7891(dir_p0, ((NI)0), i);
							nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA3_: ;
	...
	nimlf_(362, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	rawRemoveDir__stdZprivateZosdirs_u495(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();
...
LA33_: ;
							...
							nimlf_(475, "D:\\nim\\lib\\std\\private\\osdirs.nim");
							{
								...
								nimln_(477);
								if (!(kind == ((tyEnum_PathComponent__DO3jyWa6XHVeQhtgtAA9a1Q)2))) goto LA60_;

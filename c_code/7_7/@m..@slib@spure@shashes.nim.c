...
{	result = (NU32)0;
	...
	result = (NU32)((NU32)((NU32)(x_p0) << (NU32)(r_p1)) | (NU32)((NU32)(x_p0) >> (NU32)((NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_5))));
	}
BeforeRet_: ;
	popFrame();
	return result;
...
{nimErr_ = nimErrorFlag();
	...
	rem = (NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_6);
	{
		...
		while (1) {
			...
			k1_2 = (NU32)((NU32)((NU32)(k1_2) << (NU32)(((NI)8))) | ((NU32) (x_p0[(NI)(TM__7tkD9cFJSchVDwHuwaY9bP9bA_8)])));
		} LA4: ;
	}
	nimln_(348);

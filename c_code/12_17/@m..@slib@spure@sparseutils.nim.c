...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, substr__system_u7879)(NIM_CHAR* s_p0, NI s_p0Len_0);
...
LA16_: ;
				...
				nimln_(506);
				{
					...
					if (nimSubInt(((NI)IL64(9223372036854775807)), c, &TM__vI9aZNKIcImom6dDyKXW1ZA_4)) { raiseOverflow(); goto BeforeRet_;
					};
...
LA7_: ;
	{
		...
		while (1) {
			...
			case 48 ... 57:
			{
				...
				output = (NI)((NI)((NU64)(output) << (NU64)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_14));
				nimln_(197);
				foundDigit = NIM_TRUE;
			}
			break;
			case 97 ... 102:
			{
				...
				output = (NI)((NI)((NU64)(output) << (NU64)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_16));
				nimln_(200);
				foundDigit = NIM_TRUE;
			}
			break;
			case 65 ... 70:
			{
				...
				output = (NI)((NI)((NU64)(output) << (NU64)(((NI)4))) | (NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_18));
				nimln_(203);
				foundDigit = NIM_TRUE;
			}
			break;
...
LA10_: ;
		...
		T11_ = substr__system_u7879((NIM_CHAR*)(s_p0)+(((NI)0)), ((NI)(TM__vI9aZNKIcImom6dDyKXW1ZA_41))-(((NI)0))+1);
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");

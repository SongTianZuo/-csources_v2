...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(114, "D:\\nim\\compiler\\ccgutils.nim");
	T1_ = (NI64)0;
	T1_ = getSize__types_u3730(conf_p0, typ_p1);
...
LA18_: ;
		{
			...
			T23_ = (NI64)0;
			T23_ = getSize__types_u3730(conf_p0, pt);
			if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
LA14_: ;
	...
	case ((tyEnum_TTypeKind__ONzdjesiM9beeNBA9aZG5Ghw)18):
	{
		...
		T34_ = (NI64)0;
		T34_ = getSize__types_u3730(conf_p0, pt);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{	{
		...
		if (((NI)(TM__3d9b9bGbX6KaaiNN5NPQfYWQ_9)) < ((NI)0) || ((NI)(TM__3d9b9bGbX6KaaiNN5NPQfYWQ_9)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__3d9b9bGbX6KaaiNN5NPQfYWQ_9), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(67, "D:\\nim\\compiler\\ccgutils.nim");
	if ((name_p0.len) < ((NI)0) || (name_p0.len) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI(name_p0.len, ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
	}
...
appendString((&result), TM__3d9b9bGbX6KaaiNN5NPQfYWQ_54);
				...
				default:
				{
					...
					colontmpD__2 = toHex__pureZstrutils_u2072(((NU8)(c)), ((NI)2));
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;

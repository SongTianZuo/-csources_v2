...
{nimErr_ = nimErrorFlag();
	...
	nimln_(80);
	{
		...
		T5_ = substr__system_u7913(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_10));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA1_: ;
	...
	nimln_(90);
	{
		...
		T16_ = substr__system_u7901(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_16), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_17));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA14_: ;
	{
		...
		nimln_(96);
		{
			...
			T22_ = substr__system_u7901(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_19), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_20));
			nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA12_: ;
			...
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3593((&sVer2));
			eqdestroy___system_u3593((&sVer));
			goto BeforeRet_;
			{
				LA15_:;
			}
	...
	eqcopy___stdZassertions_u19((&path), p_p1);
	{
		...
		nimln_(91);
		{
			if (!(resX60gensym0_ == ((NI)0))) goto LA7_;
			{
				...
				nimlf_(101, "D:\\nim\\lib\\system\\iterators_1.nim");
				nimlf_(92, "D:\\nim\\lib\\std\\private\\osdirs.nim");
				if (nimSubInt(fX60gensym0_.gl_pathc, ((NI32)1), &TM__Xve3Bgye29aQqSXx0rQYUzw_44)) { raiseOverflow(); goto LA4_;
				};
				if (TM__Xve3Bgye29aQqSXx0rQYUzw_44 < (-2147483647 -1) || TM__Xve3Bgye29aQqSXx0rQYUzw_44 > 2147483647){ raiseOverflow(); goto LA4_;
				}
				colontmp__2 = (NI32)(TM__Xve3Bgye29aQqSXx0rQYUzw_44);
				nimlf_(107, "D:\\nim\\lib\\system\\iterators_1.nim");
				res = ((NI32)0);
				{
					nimln_(108);
					while (1) {
						...
						nimln_(93);
						{
							NIM_BOOL T14_;
							T14_ = (NIM_BOOL)0;
							T14_ = eqeq___system_u7867(fX60gensym0_.gl_pathv[iX60gensym0_], ((NCSTRING) NIM_NIL));
							if (!!(!(T14_))) goto LA15_;
...
LA19_: ;
						...
						if (TM__Xve3Bgye29aQqSXx0rQYUzw_47 < (-2147483647 -1) || TM__Xve3Bgye29aQqSXx0rQYUzw_47 > 2147483647){ raiseOverflow(); goto LA4_;
						}
						res = (NI32)(TM__Xve3Bgye29aQqSXx0rQYUzw_47);
						nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA7_: ;
	...
	nimlf_(2004, "D:\\nim\\lib\\system.nim");
	eqwasMoved___system_u3590((&resultX60gensym40_));
	nimlf_(132, "D:\\nim\\compiler\\nimblecmd.nim");
	{
		NI T25_;
		...
		colontmpD__2 = readFile__stdZsyncio_u499(nimbleLinks.p->data[((NI)0)]);
...
LA32_: ;
		...
		}
		{
			eqdestroy___stdZassertions_u16((&colontmpD__2));
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3593((&nimbleLinkLines));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
LA26_: ;
...
LA40_: ;
	...
	{
		nimlf_(2004, "D:\\nim\\lib\\system.nim");
		eqdestroy___system_u3593((&resultX60gensym40_));
		eqdestroy___system_u3593((&nimbleLinks));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");

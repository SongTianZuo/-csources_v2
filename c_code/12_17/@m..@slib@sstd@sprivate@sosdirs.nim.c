...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__stdZprivateZosdirs_u501)(NimStringV2 dir_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_u494)(NimStringV2 dir_p0);
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, tryMoveFSObject__stdZprivateZoscommon_u102)(NimStringV2 source_p0, NimStringV2 dest_p1, NIM_BOOL isDir_p2);
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(418, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__stdZprivateZosdirs_u501(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	nimln_(419);
	{
...
LA45_: ;
							...
							T50_ = substr__system_u7901(dir_p0, ((NI)0), i);
							nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA3_: ;
	...
	nimlf_(362, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	rawRemoveDir__stdZprivateZosdirs_u494(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();
...
{nimErr_ = nimErrorFlag();
	nimlf_(543, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	{
		NIM_BOOL T3_;
		T3_ = (NIM_BOOL)0;
		T3_ = tryMoveFSObject__stdZprivateZoscommon_u102(source_p0, dest_p1, NIM_TRUE);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		if (!!(T3_)) goto LA4_;
		nimln_(545);

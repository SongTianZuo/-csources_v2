...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__stdZprivateZosdirs_u499)(NimStringV2 dir_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_u492)(NimStringV2 dir_p0);
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(418, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__stdZprivateZosdirs_u499(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	nimln_(419);
	{
...
LA45_: ;
							...
							T50_ = substr__system_u7887(dir_p0, ((NI)0), i);
							nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA3_: ;
	...
	nimlf_(362, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	rawRemoveDir__stdZprivateZosdirs_u492(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();

...
N_LIB_PRIVATE N_NIMCALL(NimStringV2, ansiStyleCode__pureZterminal_u379)(NI style_p0);
...
N_LIB_PRIVATE NI gFG__pureZterminal_u362;
N_LIB_PRIVATE NI gBG__pureZterminal_u363;
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(766, "D:\\nim\\lib\\pure\\terminal.nim");
	T1_ = (int)0;
	T1_ = getFileHandle__stdZsyncio_u261(f_p0);
...
{	{
		...
		if (((NI)(TM__CN3raB9atujkEiPpxYAdlgQ_9)) < ((NI)0) || ((NI)(TM__CN3raB9atujkEiPpxYAdlgQ_9)) > ((NI)IL64(9223372036854775807))){ raiseRangeErrorI((NI)(TM__CN3raB9atujkEiPpxYAdlgQ_9), ((NI)0), ((NI)IL64(9223372036854775807))); goto BeforeRet_;
		}
...
{nimErr_ = nimErrorFlag();
	...
	formatValue__pureZterminal_u256((&fmtRes), style_p0, TM__CN3raB9atujkEiPpxYAdlgQ_6);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	prepareAdd((&fmtRes), 1);
		...
		i = ((NI)1);
		{
			...
			while (1) {
				...
				nimln_(59);
				{
					...
					colontmpD_ = ansiStyleCode__pureZterminal_u379(((NI) (s)));
...
{nimErr_ = nimErrorFlag();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	nimln_(570);
	gFG__pureZterminal_u362 = ((NI)0);
	nimln_(571);
	gBG__pureZterminal_u363 = ((NI)0);
	}
BeforeRet_: ;
	popFrame();
}
...
{nimErr_ = nimErrorFlag();
	colontmpD_.len = 0; colontmpD_.p = NIM_NIL;
	nimlf_(680, "D:\\nim\\lib\\pure\\terminal.nim");
	gFG__pureZterminal_u362 = fg_p1;
	nimln_(681);
	{
		NI TM__CN3raB9atujkEiPpxYAdlgQ_14;
		if (!bright_p2) goto LA4_;
		if (nimAddInt(gFG__pureZterminal_u362, ((NI)60), &TM__CN3raB9atujkEiPpxYAdlgQ_14)) { raiseOverflow(); goto LA1_;
		};
		gFG__pureZterminal_u362 = (NI)(TM__CN3raB9atujkEiPpxYAdlgQ_14);
	}
LA4_: ;
	nimln_(682);
	colontmpD_ = ansiStyleCode__pureZterminal_u379(gFG__pureZterminal_u362);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	write__stdZsyncio_u238(f_p0, colontmpD_);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	{

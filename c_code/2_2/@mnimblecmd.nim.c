...
} TM__Xve3Bgye29aQqSXx0rQYUzw_44 = { 81 | NIM_STRLIT_FLAG, "D:\\nim\\lib\\std\\private\\osdirs.nim(93, 15) `f`gensym0.gl_pathv[i`gensym0] != nil` " };
static const NimStringV2 TM__Xve3Bgye29aQqSXx0rQYUzw_45 = {81, (NimStrPayload*)&TM__Xve3Bgye29aQqSXx0rQYUzw_44};
static const struct {
  NI cap; NIM_CHAR data[117+1];
} TM__Xve3Bgye29aQqSXx0rQYUzw_47 = { 117 | NIM_STRLIT_FLAG, "D:\\nim\\lib\\pure\\collections\\tables.nim(701, 13) `len(t) == L` the length of the table changed while iterating over it" };
static const NimStringV2 TM__Xve3Bgye29aQqSXx0rQYUzw_48 = {117, (NimStrPayload*)&TM__Xve3Bgye29aQqSXx0rQYUzw_47};
static const struct {
  NI cap; NIM_CHAR data[108+1];
} TM__Xve3Bgye29aQqSXx0rQYUzw_52 = { 108 | NIM_STRLIT_FLAG, "D:\\nim\\lib\\system\\iterators.nim(246, 11) `len(a) == L` the length of the seq changed while iterating over it" };
static const NimStringV2 TM__Xve3Bgye29aQqSXx0rQYUzw_53 = {108, (NimStrPayload*)&TM__Xve3Bgye29aQqSXx0rQYUzw_52};
...
((NI)14)}
;
static NIM_CONST tyTuple__kN8up2W6YKc5YA9avn5mV5w TM__Xve3Bgye29aQqSXx0rQYUzw_46 = {{29, (NimStrPayload*)&TM__Xve3Bgye29aQqSXx0rQYUzw_39},
((NI)142),
((NI)11)}
;
				...
				res = 0ULL;
				{
					...
					while (1) {
						...
						nimln_(93);
						{
							...
							if (!!(!(T14_))) goto LA15_;
							failedAssertImpl__stdZassertions_u274(TM__Xve3Bgye29aQqSXx0rQYUzw_45);
...
LA7_: ;
	...
	nimlf_(132, "D:\\nim\\compiler\\nimblecmd.nim");
	{
		...
		colontmpD__2 = readFile__stdZsyncio_u502(nimbleLinks.p->data[((NI)0)]);
...
LA26_: ;
	nimlf_(141, "D:\\nim\\compiler\\nimblecmd.nim");
	{
		...
		if (!!(T39_)) goto LA40_;
		nimln_(142);
		liMessage__msgs_u1216(conf_p0, info_p2, ((tyEnum_TMsgKind__aghsq7zHWm205GRPJE9a2yw)97), path, ((tyEnum_TErrorHandling__eXg3xAZwMffPDYOafyM3aQ)0), (&TM__Xve3Bgye29aQqSXx0rQYUzw_46), NIM_FALSE);
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
		nimln_(143);
		blitTmp = path;
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
		...
		p_2.len = 0; p_2.p = NIM_NIL;
		{
			...
			if (NIM_UNLIKELY(*nimErr_)) goto LA97_;
			{
				...
				res = ((NI)0);
				{
					nimln_(91);
					while (1) {
						NI TM__Xve3Bgye29aQqSXx0rQYUzw_49;
...
LA114_: ;
							...
							nimlf_(701, "D:\\nim\\lib\\pure\\collections\\tables.nim");
							{
								...
								failedAssertImpl__stdZassertions_u274(TM__Xve3Bgye29aQqSXx0rQYUzw_48);
								if (NIM_UNLIKELY(*nimErr_)) goto LA107_;
							}
LA119_: ;
							{
...
LA105_: ;
						nimlf_(93, "D:\\nim\\lib\\system\\iterators_1.nim");
						if (nimAddInt(res, ((NI)1), &TM__Xve3Bgye29aQqSXx0rQYUzw_49)) { raiseOverflow(); goto LA97_;
						};
						res = (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_49);
					} LA101: ;
				}
			}
			{
...
{nimErr_ = nimErrorFlag();
	...
	result = ((NI)0);
	{
		...
		L = T2_;
		{
			nimln_(243);
			while (1) {
				NI TM__Xve3Bgye29aQqSXx0rQYUzw_50;
...
LA8_: ;
				nimln_(1624);
				if (nimAddInt(result, ((NI)1), &TM__Xve3Bgye29aQqSXx0rQYUzw_50)) { raiseOverflow(); goto BeforeRet_;
				};
				result = (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_50);
				nimlf_(245, "D:\\nim\\lib\\system\\iterators.nim");
				if (nimAddInt(i_2, ((NI)1), &TM__Xve3Bgye29aQqSXx0rQYUzw_51)) { raiseOverflow(); goto BeforeRet_;
				};
				i_2 = (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_51);
				nimln_(246);
				{
					NI T12_;
					T12_ = a_p0.len;
					if (!!((T12_ == L))) goto LA13_;
					failedAssertImpl__stdZassertions_u274(TM__Xve3Bgye29aQqSXx0rQYUzw_53);
					if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
				}
LA13_: ;
			} LA4: ;

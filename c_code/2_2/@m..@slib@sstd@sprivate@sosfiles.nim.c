...
LA17_: ;
	{
		...
		nimlf_(239, "D:\\nim\\lib\\std\\private\\osfiles.nim");
		{
			...
			NI32 T28_;
			T25_ = (NIM_BOOL)0;
			T25_ = open__stdZsyncio_u402(&s, source_p0, ((tyEnum_FileMode__9atfYUlw9bQtL4ixYGhUZZfQ)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T25_)) goto LA26_;
			T28_ = (NI32)0;
...
LA26_: ;
		nimln_(240);
		{
			...
			NI32 T34_;
			T31_ = (NIM_BOOL)0;
			T31_ = open__stdZsyncio_u402(&d, dest_p1, ((tyEnum_FileMode__9atfYUlw9bQtL4ixYGhUZZfQ)1), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			if (!!(T31_)) goto LA32_;
			nimln_(241);

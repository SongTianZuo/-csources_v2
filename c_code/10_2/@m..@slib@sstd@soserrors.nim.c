...
struct tySequence__OC4OxQhfzCBuUQxMi5llBQ_Content { NI cap; tyObject_StackTraceEntry__cwz3X1atIa8ET8VanDA2pw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NOINLINE(tyObject_OSError__364R2OEHwjKXXXZy8WY36g*, newOSError__stdZoserrors_u28)(NI32 errorCode_p0, NimStringV2 additionalInfo_p1);
...
{nimErr_ = nimErrorFlag();
	...
	nimln_(79);
	{
		...
		nimln_(80);
		{
			...
			if (!(T8_)) goto LA9_;
			T10_ = (NIM_CHAR*)0;
			T10_ = X5BX5D___system_u7429((&(*result).Sup.Sup.message), ((NI)1));
			if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
			T8_ = !(((NU8)((*T10_)) == (NU8)(10)));
LA9_: ;
			if (!T8_) goto LA11_;
...
{nimErr_ = nimErrorFlag();
	nimlf_(92, "D:\\nim\\lib\\std\\oserrors.nim");
	T1_ = NIM_NIL;
	T1_ = newOSError__stdZoserrors_u28(errorCode_p0, additionalInfo_p1);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;

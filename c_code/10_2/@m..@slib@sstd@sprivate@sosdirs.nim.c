...
N_LIB_PRIVATE N_NIMCALL(NIM_BOOL, rawCreateDir__stdZprivateZosdirs_u486)(NimStringV2 dir_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, rawRemoveDir__stdZprivateZosdirs_u479)(NimStringV2 dir_p0);
...
LA8_: ;
	{
		...
		nimln_(385);
		T11_ = (NI32)0;
		T11_ = osLastError__stdZoserrors_u85();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_u82(T11_, dir_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA1_: ;
	}
...
{nimErr_ = nimErrorFlag();
	...
	nimlf_(418, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	T1_ = (NIM_BOOL)0;
	T1_ = rawCreateDir__stdZprivateZosdirs_u486(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	result = !(T1_);
	nimln_(419);
	{
...
LA45_: ;
							...
							T50_ = substr__system_u7918(dir_p0, ((NI)0), i);
							nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA5_: ;
		if (!T3_) goto LA6_;
		T8_ = (NI32)0;
		T8_ = osLastError__stdZoserrors_u85();
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
		raiseOSError__stdZoserrors_u82(T8_, dir_p0);
		if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
LA6_: ;
	}
...
LA3_: ;
	...
	nimlf_(362, "D:\\nim\\lib\\std\\private\\osdirs.nim");
	rawRemoveDir__stdZprivateZosdirs_u479(dir_p0);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();
	...
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	{
		...
		nimln_(228);
		{
			...
			nimln_(229);
			{
				...
				T11_ = osLastError__stdZoserrors_u85();
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
				raiseOSError__stdZoserrors_u82(T11_, source_p0);
				if (NIM_UNLIKELY(*nimErr_)) goto LA2_;
			}
LA9_: ;
		}

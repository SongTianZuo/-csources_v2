...
appendString((&T8_), colontmpD__3);
		...
		nimln_(34);
		{
			...
			if (!(T11_)) goto LA12_;
			T11_ = open__stdZsyncio_u401(&f, filename, ((tyEnum_FileMode__9atfYUlw9bQtL4ixYGhUZZfQ)0), ((NI)-1));
			if (NIM_UNLIKELY(*nimErr_)) goto LA6_;
LA12_: ;
			if (!T11_) goto LA13_;
			colontmp_.len = 0; colontmp_.p = NIM_NIL;
			nimln_(35);
			colontmp_ = readAll__stdZsyncio_u371(f);
...
LA24_: ;
		...
		nimln_(49);
		{
			...
			nimln_(50);
			writeFile__stdZsyncio_u504(filename, result.Field0);
			if (NIM_UNLIKELY(*nimErr_)) goto LA19_;
		}
LA34_: ;
		{
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 782358016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 2920404992)) {
				*nimErr_ = NIM_FALSE;
				nimlf_(52, "D:\\nim\\compiler\\gorgeimpl.nim");
				{
					...
					colontmpD__7 = getCurrentExceptionMsg__system_u7275();
		...
		if (NIM_UNLIKELY(*nimErr_)) {
			...
			if (isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 782358016)||isObjDisplayCheck(nimBorrowCurrentException()->Sup.m_type, 3, 2920404992)) {
				...
				*nimErr_ = NIM_FALSE;
				...
				colontmpD__10 = getCurrentExceptionMsg__system_u7275();

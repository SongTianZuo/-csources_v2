...
struct tySequence__OC4OxQhfzCBuUQxMi5llBQ_Content { NI cap; tyObject_StackTraceEntry__cwz3X1atIa8ET8VanDA2pw data[SEQ_DECL_SIZE];};
      ...
      N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4389)(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg* dest_p0);
...
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4398)(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4446)(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4455)(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4800)(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4809)(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4524)(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4533)(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4854)(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4863)(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___stdZoserrors_u35)(tyObject_OSError__364R2OEHwjKXXXZy8WY36g* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___stdZoserrors_u44)(tyObject_OSError__364R2OEHwjKXXXZy8WY36g* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u7989)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u7998)(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg* dest_p0, void* env_p1);
...
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4643)(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4652)(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw* dest_p0, void* env_p1);
N_LIB_PRIVATE N_NIMCALL(void, eqdestroy___system_u4219)(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw* dest_p0);
N_LIB_PRIVATE N_NIMCALL(void, eqtrace___system_u4228)(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw* dest_p0, void* env_p1);
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__WyH4kDTTwxjzV9brTg3MIsg_ = {.destructor = (void*)eqdestroy___system_u4389, .size = sizeof(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg), .align = (NI16) NIM_ALIGNOF(tyObject_RangeDefect__WyH4kDTTwxjzV9brTg3MIsg), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_3, .traceImpl = (void*)eqtrace___system_u4398, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_8[4] = {3701606400, 1285336064, 1375453440, 2539992832};
N_LIB_PRIVATE TNimTypeV2 NTIv2__NJdlNxUmKiqDB6nnzMNJbQ_ = {.destructor = (void*)eqdestroy___system_u4446, .size = sizeof(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ), .align = (NI16) NIM_ALIGNOF(tyObject_IndexDefect__NJdlNxUmKiqDB6nnzMNJbQ), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_8, .traceImpl = (void*)eqtrace___system_u4455, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_9[5] = {3701606400, 1285336064, 1375453440, 1155872768, 205641216};
N_LIB_PRIVATE TNimTypeV2 NTIv2__PwxB1gj2RB604hR0Dczyzg_ = {.destructor = (void*)eqdestroy___system_u4800, .size = sizeof(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg), .align = (NI16) NIM_ALIGNOF(tyObject_OverflowDefect__PwxB1gj2RB604hR0Dczyzg), .depth = 4, .display = TM__TzI3paKQY09cLjc9cmCvur3A_9, .traceImpl = (void*)eqtrace___system_u4809, .flags = 0};
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__e6AN4WVr2NKlqdq8x5qlFQ_ = {.destructor = (void*)eqdestroy___system_u4524, .size = sizeof(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ), .align = (NI16) NIM_ALIGNOF(tyObject_FieldDefect__e6AN4WVr2NKlqdq8x5qlFQ), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_12, .traceImpl = (void*)eqtrace___system_u4533, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_13[5] = {3701606400, 1285336064, 1375453440, 1155872768, 3774929920};
N_LIB_PRIVATE TNimTypeV2 NTIv2__59bEA3GZnnoahAU0veRzG6A_ = {.destructor = (void*)eqdestroy___system_u4854, .size = sizeof(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A), .align = (NI16) NIM_ALIGNOF(tyObject_DivByZeroDefect__59bEA3GZnnoahAU0veRzG6A), .depth = 4, .display = TM__TzI3paKQY09cLjc9cmCvur3A_13, .traceImpl = (void*)eqtrace___system_u4863, .flags = 0};
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__364R2OEHwjKXXXZy8WY36g_ = {.destructor = (void*)eqdestroy___stdZoserrors_u35, .size = sizeof(tyObject_OSError__364R2OEHwjKXXXZy8WY36g), .align = (NI16) NIM_ALIGNOF(tyObject_OSError__364R2OEHwjKXXXZy8WY36g), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_15, .traceImpl = (void*)eqtrace___stdZoserrors_u44, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_16[4] = {3701606400, 1285336064, 502999040, 782358016};
N_LIB_PRIVATE TNimTypeV2 NTIv2__Vy6h1gTZNMhIMVGxEYGYlg_ = {.destructor = (void*)eqdestroy___system_u7989, .size = sizeof(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg), .align = (NI16) NIM_ALIGNOF(tyObject_IOError__Vy6h1gTZNMhIMVGxEYGYlg), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_16, .traceImpl = (void*)eqtrace___system_u7998, .flags = 0};
...
N_LIB_PRIVATE TNimTypeV2 NTIv2__4qtxOmDc9byiuSxzwS6BAmw_ = {.destructor = (void*)eqdestroy___system_u4643, .size = sizeof(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw), .align = (NI16) NIM_ALIGNOF(tyObject_ObjectConversionDefect__4qtxOmDc9byiuSxzwS6BAmw), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_18, .traceImpl = (void*)eqtrace___system_u4652, .flags = 0};
static NIM_CONST NU32 TM__TzI3paKQY09cLjc9cmCvur3A_19[4] = {3701606400, 1285336064, 1375453440, 2302286080};
N_LIB_PRIVATE TNimTypeV2 NTIv2__64k6GXy1HJpPQ8jVz2xjTw_ = {.destructor = (void*)eqdestroy___system_u4219, .size = sizeof(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw), .align = (NI16) NIM_ALIGNOF(tyObject_ReraiseDefect__64k6GXy1HJpPQ8jVz2xjTw), .depth = 3, .display = TM__TzI3paKQY09cLjc9cmCvur3A_19, .traceImpl = (void*)eqtrace___system_u4228, .flags = 0};
static N_INLINE(void, nimFrame)(TFrame* s_p0) {
	{

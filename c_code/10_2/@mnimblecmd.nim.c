...
{nimErr_ = nimErrorFlag();
	...
	nimln_(80);
	{
		...
		T5_ = substr__system_u7930(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_10));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA1_: ;
	...
	nimln_(90);
	{
		...
		T16_ = substr__system_u7918(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_16), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_17));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA14_: ;
	{
		...
		nimln_(96);
		{
			...
			T22_ = substr__system_u7918(p_p0, (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_19), (NI)(TM__Xve3Bgye29aQqSXx0rQYUzw_20));
			nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA12_: ;
			...
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3629((&sVer2));
			eqdestroy___system_u3629((&sVer));
			goto BeforeRet_;
			{
				LA15_:;
			}
				...
				res = ((NI)0);
				{
					...
					while (1) {
						...
						nimln_(93);
						{
							NIM_BOOL T14_;
							T14_ = (NIM_BOOL)0;
							T14_ = eqeq___system_u7884(fX60gensym0_.gl_pathv[iX60gensym0_], ((NCSTRING) NIM_NIL));
							if (!!(!(T14_))) goto LA15_;
...
LA7_: ;
	...
	nimlf_(2004, "D:\\nim\\lib\\system.nim");
	eqwasMoved___system_u3626((&resultX60gensym40_));
	nimlf_(132, "D:\\nim\\compiler\\nimblecmd.nim");
	{
		NI T25_;
...
LA32_: ;
		...
		}
		{
			eqdestroy___stdZassertions_u16((&colontmpD__2));
			nimlf_(2004, "D:\\nim\\lib\\system.nim");
			eqdestroy___system_u3629((&nimbleLinkLines));
		}
		if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
	}
LA26_: ;
...
LA40_: ;
	...
	{
		nimlf_(2004, "D:\\nim\\lib\\system.nim");
		eqdestroy___system_u3629((&resultX60gensym40_));
		eqdestroy___system_u3629((&nimbleLinks));
		nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
...
LA4_: ;
	{
		...
		nimln_(228);
		{
			...
			nimln_(229);
			{
				...
				nimln_(230);
				T16_ = (NI32)0;
				T16_ = osLastError__stdZoserrors_u85();
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
				raiseOSError__stdZoserrors_u82(T16_, dir_p1);
				if (NIM_UNLIKELY(*nimErr_)) goto LA7_;
			}
LA14_: ;
		}
...
LA38_: ;
							...
							nimlf_(149, "D:\\nim\\compiler\\nimblecmd.nim");
							{
								...
								nimln_(150);
								T65_ = (NIM_BOOL)0;
								T65_ = (k == ((tyEnum_PathComponent__DO3jyWa6XHVeQhtgtAA9a1Q)2));
								if (!(T65_)) goto LA66_;
				...
				res = ((NI)0);
				{
					...
					while (1) {
						...
						h = res;
						{
							...
							NimStringV2 res_2;
							nimln_(699);
							if (h < 0 || h >= packages.data.len){ raiseIndexError2(h,packages.data.len-1); goto LA80_;
							}
							T87_ = (NIM_BOOL)0;
							T87_ = isFilled__pureZcollectionsZtables_u33(packages.data.p->data[h].Field0);
							if (NIM_UNLIKELY(*nimErr_)) goto LA80_;
							if (!T87_) goto LA88_;
							res_2.len = 0; res_2.p = NIM_NIL;
							nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");
							if (h < 0 || h >= packages.data.len){ raiseIndexError2(h,packages.data.len-1); goto LA90_;
							}
...
LA97_: ;
							...
							nimlf_(701, "D:\\nim\\lib\\pure\\collections\\tables.nim");
							{
								NI T101_;
								T101_ = (NI)0;
								T101_ = len__nimblecmd_u2014(packages);
								if (NIM_UNLIKELY(*nimErr_)) goto LA90_;
								if (!!((T101_ == L))) goto LA102_;
...
LA88_: ;
						nimlf_(93, "D:\\nim\\lib\\system\\iterators_1.nim");
						if (nimAddInt(res, ((NI)1), &TM__Xve3Bgye29aQqSXx0rQYUzw_51)) { raiseOverflow(); goto LA80_;
						};

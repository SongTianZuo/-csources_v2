...
LA4_: ;
		...
		prefix = substr__system_u7906(s_p0, ((NI)0), (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_3));
		nimln_(82);
		if (nimAddInt(ri, ((NI)1), &TM__Vbi6rBBOqdMySprhH3iUcg_4)) { raiseOverflow(); goto LA7_;
		};
		suffix = substr__system_u7918(s_p0, (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_4));
		{
			NimStringV2 middle;
			...
			colontmp_ = substr__system_u7906(s_p0, (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_5), (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_6));
			nimlf_(386, "D:\\nim\\lib\\pure\\strutils.nim");
...
LA19_: ;
					...
					T21_ = substr__system_u7906(colontmp_, firstX60gensym33_, (NI)(TM__Vbi6rBBOqdMySprhH3iUcg_8));
					nimlf_(25, "D:\\nim\\lib\\std\\assertions.nim");

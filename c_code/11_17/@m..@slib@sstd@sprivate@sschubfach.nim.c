...
N_LIB_PRIVATE NIM_CONST tyArray__ocdlWeLAycDNOOtB9cadACA g__stdZprivateZschubfach_u79 = {9353610478917778677ULL,
...
N_LIB_PRIVATE N_NIMCALL(tyObject_Single__hJniJAz3lUapMk9atjc1HBA, constructSingle__stdZprivateZschubfach_u32)(NF32 value_p0) {
	tyObject_Single__hJniJAz3lUapMk9atjc1HBA result;
	union { NF32 source; NU32 dest; } LOC1;
	nimZeroMem((void*)(&result), sizeof(tyObject_Single__hJniJAz3lUapMk9atjc1HBA));

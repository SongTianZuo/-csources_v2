...
{nimErr_ = nimErrorFlag();
	...
	colontmpD__2 = multiReplace__pureZstrutils_u1948(colontmpD_, TM__GNhKqIyvrFjtq6zf1JX7qg_6, 5);
	if (NIM_UNLIKELY(*nimErr_)) goto LA1_;
...
{nimErr_ = nimErrorFlag();
	result.len = 0; result.p = NIM_NIL;
	nimlf_(86, "D:\\nim\\compiler\\modulepaths.nim");
	result = multiReplace__pureZstrutils_u1948(path_p0, TM__GNhKqIyvrFjtq6zf1JX7qg_55, 5);
	if (NIM_UNLIKELY(*nimErr_)) goto BeforeRet_;
	}
BeforeRet_: ;
	popFrame();
